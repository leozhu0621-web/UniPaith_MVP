...
export const updateProfile = (data: Record<string, unknown>) =>
  apiClient.put('/students/me/profile', data).then(r => r.data)
...
export const createAcademic = (data: Record<string, unknown>) =>
  apiClient.post('/students/me/academics', data).then(r => r.data)
export const updateAcademic = (id: string, data: Record<string, unknown>) =>
  apiClient.put(`/students/me/academics/${id}`, data).then(r => r.data)
...
export const createTestScore = (data: Record<string, unknown>) =>
  apiClient.post('/students/me/test-scores', data).then(r => r.data)
export const updateTestScore = (id: string, data: Record<string, unknown>) =>
  apiClient.put(`/students/me/test-scores/${id}`, data).then(r => r.data)
...
export const createActivity = (data: Record<string, unknown>) =>
  apiClient.post('/students/me/activities', data).then(r => r.data)
export const updateActivity = (id: string, data: Record<string, unknown>) =>
  apiClient.put(`/students/me/activities/${id}`, data).then(r => r.data)
...
export const upsertPreferences = (data: Record<string, unknown>) =>
  apiClient.put('/students/me/preferences', data).then(r => r.data)
