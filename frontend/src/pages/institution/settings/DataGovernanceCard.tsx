 ...
 * (The §6 fairness auto-halt surface lives at /i/admissions?tab=fairness.)
 */
        ...
        {data.program_thresholds.length > 0 && (
          <div className="py-2.5 border-t border-border">
            ...
            <p className="text-xs text-muted-foreground mt-2">
              Tune individual thresholds and review halts on the{' '}
              <a
                href="/i/admissions?tab=fairness"
      ...
      >
        <div className="flex gap-2">
          <Button
            size="sm"
            variant="tertiary"
            onClick={() => window.open('/i/analytics?export=csv', '_self')}
          >
