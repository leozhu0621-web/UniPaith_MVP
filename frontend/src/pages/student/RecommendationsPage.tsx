    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      {recs.length === 0 ? (
        <EmptyState
          ...
          description="Add your recommenders and track their letter submissions."
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
      ...
      <div>
        ...
        <select {...register('relationship')} className="w-full text-sm border border-gray-300 rounded-lg px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-gray-900">
