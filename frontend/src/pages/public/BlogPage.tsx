        ...
        <div className="max-w-3xl mx-auto text-center">
          <ScrollReveal variant="blur-in">
            <div className="w-16 h-16 rounded-2xl bg-student-mist flex items-center justify-center mx-auto mb-6">
              <BookOpen className="text-student" size={32} />
            </div>
            ...
            <div className="bg-card rounded-2xl border p-8 max-w-md mx-auto">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-lg border px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-student"
                />
                <button className="bg-student hover:bg-charcoal text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors">
                  Notify me
                </button>
              </div>
            </div>
