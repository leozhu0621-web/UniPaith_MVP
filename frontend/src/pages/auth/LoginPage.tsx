...
export default function LoginPage() {
  ...
  const googleLogin = () => {
    ...
    const url = `https://${cognitoDomain}/oauth2/authorize?client_id=${clientId}&response_type=code&scope=openid+email+profile&redirect_uri=${encodeURIComponent(redirectUri)}&identity_provider=Google`
