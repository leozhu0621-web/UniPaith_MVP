    ...
    <div className="flex flex-col h-full bg-card border-r border-border">
      ...
      <div className="flex items-center justify-between px-3 py-2.5 border-b border-border flex-shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-foreground">Counselor</span>
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-2 space-y-2">
        {messages.length === 0 && (
          <p className="text-[10px] text-foreground text-center py-4">
        ...
        {sendMut.isPending && (
          <div className="flex gap-1.5">
            ...
            <div className="px-2.5 py-1.5 rounded-xl bg-muted">
              <div className="flex gap-0.5">
                <span className="w-1 h-1 bg-foreground/30 rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
                <span className="w-1 h-1 bg-foreground/30 rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
                <span className="w-1 h-1 bg-foreground/30 rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
              </div>
            </div>
          </div>
        )}
