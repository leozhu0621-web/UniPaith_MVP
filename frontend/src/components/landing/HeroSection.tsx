...
const HeroSection = () => (
  <section className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-cloud">
    <div className="absolute inset-0 -z-10">
      <div className="absolute top-20 left-[10%] w-72 h-72 bg-mist rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-20 right-[10%] w-96 h-96 bg-mist rounded-full blur-3xl animate-float-slow" />
      <div className="absolute top-1/3 right-[20%] w-48 h-48 bg-sand-light/40 rounded-full blur-3xl animate-float" style={{ animationDelay: "2s" }} />
    </div>

    <div className="max-w-5xl mx-auto text-center">
      <ScrollReveal variant="blur-in">
        <div className="inline-flex items-center gap-2 bg-mist text-harbor rounded-full px-5 py-2 text-sm font-medium mb-8">
          Everything a $6K agent does &mdash; for free
        </div>
      </ScrollReveal>

      <ScrollReveal delay={200} variant="scale-up">
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-ink leading-[1.1] mb-6 tracking-tight font-heading">
          Your private{" "}
          <br className="hidden sm:block" />
          <span className="text-harbor">college advisor</span>
        </h1>
      </ScrollReveal>
