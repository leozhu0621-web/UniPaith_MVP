"""Seed US-News-tier national universities (batch 4, set 0-50) at institution level.
...
omitted. Data in the sibling seed3b4_data.json. Idempotent: skips existing names.

Revision ID: seed3b4
Revises: jhustanmerge1
"""
...
_DATA = pathlib.Path(__file__).with_name("seed3b4_data.json")
