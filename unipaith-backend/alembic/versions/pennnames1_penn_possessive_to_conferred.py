"""Penn possessive-mint names → conferred degree designations (REPAIR BACKLOG #8)

Resolves Penn's ~53% possessive-mint program names ("Bachelor's in {field}" /
...
(Area Studies, Accounting and Related Services) and resolves Biochemistry CIP rollup
to the real Penn degree name. Re-applies ``penn_profile.apply()`` and re-derives
target-applicant rows for the matcher.

Revision ID: pennnames1
Revises: cornellnames1
