"""Harvard LiveWhale events feed repair.

Replaces the dead Harvard College iCal URL
``https://calendar.college.harvard.edu/calendar.ics`` with the current
Harvard-owned LiveWhale iCal feed, verified 2026-06-30 to return 200+ VEVENTs.
Re-applies ``harvard_profile.apply()`` so institution, school, and program
``content_sources`` inherit the working feed.

Revision ID: harvfeed1
Revises: budescslug1
