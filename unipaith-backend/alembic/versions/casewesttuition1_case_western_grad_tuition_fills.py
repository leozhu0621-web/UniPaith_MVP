...
``cip_code`` filled, ≥4 photos, live news feed) but shipped 11 master's programs with a
NULL ``tuition`` recorded as omit-with-reason — even though CWRU DOES publish a
verifiable rate for each, so the CPEF matcher scored their budget fit blind. Each rate
below was re-verified this run against CWRU's first-party student-accounts pages:
...
- Six postdoctoral M.S.D. dental specialties (Orthodontics, Periodontics, Endodontics,
  ...
  graduate-dental rate $34,794/semester (12+ credits, 2025-26) → full-time year x2 =
  $69,588 (School of Dental Medicine student-accounts page; corroborated by the
  Orthodontics M.S.D. bulletin cost figure).
...
- School of Law M.C.R.M. and Patent Practice M.A. → the 10+ credit (full-time) flat rate
  $24,400/semester (2026-27) → $48,800/year (distinctly below the J.D./LL.M. tier).
- Weatherhead M.S. Leadership & Organizational Change ($1,602/credit) and M.S. Business
  Analytics & Intelligence ($1,716/credit), 2025-26 → x24 full-time credits.

The Master of Legal Studies and M.A. Financial Integrity (absent from the Law
student-accounts price table) and the S.J.D./D.M.A. research/performance doctorates keep
their honest omit-with-reason. The events feed url was also normalized to its resolvable
HTTPS Google-Calendar form.
