"""Seed US-News-tier national universities (batch 6, set 100-150) at institution level.
...
omitted. Data in the sibling seed3b6_data.json. Idempotent: skips existing names.
...
revision = "seed3b6"
down_revision = "seed3b5"
branch_labels = None
depends_on = None

_DATA = pathlib.Path(__file__).with_name("seed3b6_data.json")
