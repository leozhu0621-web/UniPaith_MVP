...
target-applicant rows. Chains after ``harvardcip2`` (the latest head at merge time, after
the concurrent #1090/#1093/#1095 Harvard+Cornell repairs), keeping ``main`` at a single head.
