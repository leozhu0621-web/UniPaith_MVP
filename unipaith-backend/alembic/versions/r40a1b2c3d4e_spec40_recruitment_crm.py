...
# Rebased onto the current single head after Spec 38 + Spec 39 merged ahead of
# this branch (s3839merge1a2b merges the Spec 38 and Spec 39 heads). Chaining off
# it keeps the graph single-headed (test_alembic_has_single_head). Spec 39 added
# no agents, so the agent CHECK below still extends the Spec 38 vocabulary.
down_revision = "s3839merge1a2b"  # pragma: allowlist secret
branch_labels = None
depends_on = None
