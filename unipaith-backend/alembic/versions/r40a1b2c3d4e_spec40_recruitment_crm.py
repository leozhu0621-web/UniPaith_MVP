...
# Post-Spec-40 agent vocabulary (adds the two recruitment agents to the
# Spec-35 set; Spec 36/37 added no agents).
_AGENT_CHECK_NEW = (
...
# Prior state (the head's vocabulary — Spec 35 added the two yield agents).
_AGENT_CHECK_OLD = (
    "agent IN ('orchestrator','extractor','validator','feature_emitter',"
    "'rationale','workshop_coach','workshop_judge','embedding',"
    "'review_summarizer','authenticity_risk','matcher','query_interpreter',"
