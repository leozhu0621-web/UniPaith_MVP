...
# MERGE migration: main is currently dual-headed — Spec 41 (g41a1b2c3d4e, #237,
# adds the three graduate agents) and Spec 12's NYU-ranking backfill
# (c13d1ef6a8b0, #240) both branch off b12c0de5f7a9. This migration unifies both
# heads AND carries the Prompt Library DDL, restoring a single head
# (test_alembic_has_single_head). Both parents apply before upgrade() runs; c13
# is data-only and g41 sets the agent vocabulary the CHECK constants extend.
down_revision = ("g41a1b2c3d4e", "c13d1ef6a8b0")  # pragma: allowlist secret
branch_labels = None
depends_on = None
