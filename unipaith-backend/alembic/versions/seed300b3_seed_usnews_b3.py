"""Seed US-News National Universities ranks 110-152 (batch 3) at institution level.
...
omitted. Data in the sibling seed300b3_data.json. Idempotent: skips existing names.

Revision ID: seed300b3
Revises: seed300b2
"""
...
revision = "seed300b3"
down_revision = "seed300b2"
branch_labels = None
depends_on = None

_DATA = pathlib.Path(__file__).with_name("seed300b3_data.json")
