"""Seed US-News National Universities ranks 37-75 (batch 1) at institution level.
...
omitted. Data in the sibling seed300b1_data.json. Idempotent: skips existing names.

Revision ID: seed300b1
Revises: uclaprof3
"""
...
revision = "seed300b1"
down_revision = "uclaprof3"
branch_labels = None
depends_on = None

_DATA = pathlib.Path(__file__).with_name("seed300b1_data.json")
