"""Seed US-News-tier national universities (batch 5, set 50-100) at institution level.
...
omitted. Data in the sibling seed3b5_data.json. Idempotent: skips existing names.
...
revision = "seed3b5"
down_revision = "seed3b4"
branch_labels = None
depends_on = None

_DATA = pathlib.Path(__file__).with_name("seed3b5_data.json")
