"""The UW-Madison profile conforms to the gold standard across its WHOLE tree — the
institution, every one of its 15 real schools, and every one of its programs —
...
def test_catalog_breadth_and_shape():
    ...
    assert "public research university in madison" in p.DESCRIPTION.lower()
