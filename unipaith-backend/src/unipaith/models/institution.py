...
class Program(Base):
    ...
    # Fairness auto-halt (gap audit G-I5 / Spec 43 §6): when the disparate-
    # impact delta breaches threshold for 2 consecutive weeks, the matcher
    # stops scoring new applicants for this program until a human overrides.
    matching_halted: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    # Per-program override of the default 0.20 disparate-impact threshold.
    fairness_threshold_override: Mapped[float | None] = mapped_column(Float)
