...
class Program(Base):
    ...
    tracks: Mapped[list | None] = mapped_column(JSONB)
    outcomes_data: Mapped[dict | None] = mapped_column(JSONB)
    intake_rounds: Mapped[list | None] = mapped_column(JSONB)
    media_urls: Mapped[list | None] = mapped_column(JSONB)
    highlights: Mapped[list | None] = mapped_column(JSONB)
    faculty_contacts: Mapped[list | None] = mapped_column(JSONB)
...
class InstitutionPost(Base):
    ...
    tagged_program_ids: Mapped[list | None] = mapped_column(JSONB)
