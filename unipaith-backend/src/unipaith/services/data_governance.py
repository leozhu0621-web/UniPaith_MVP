...
This complements Spec 46 §6 (the fairness auto-halt engine in
``services/fairness_service``): §6 owns the per-program threshold + halt; this
module owns the institution-wide governance config + the disclosure surfaces.
"""
