...
CATALOG: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "tier": "standard",
        "ask_kind": "scale",
        "question": "How much do research opportunities matter to you?",
    },
    {
        "key": "weight_campus_life",
        "type": "weight",
        "tier": "standard",
        "ask_kind": "scale",
        "question": "How much does campus life matter to you?",
    },
    {
    ...
    # ask_kind "keywords" = curated suggestion chips the student can add to (free-add);
    # "multi" = constrained pick-from-fixed-set.
    {
    ...
    # ── standard (direction) ──
    {
        ...
        "tier": "standard",
        "ask_kind": "keywords",
        "question": "Any specific focus or specialization?",
        "options": [
            "Machine learning",
