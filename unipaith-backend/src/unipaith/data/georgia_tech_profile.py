...
_SCHOOL_FEED_SPEC: dict[str, dict] = {
    ...
    _IAC: {"keywords": ["Ivan Allen College", "liberal arts", "public policy", "international affairs"]},
...
_SPECIAL: dict[str, tuple[str, str, str]] = {
    ...
    "mba": ("Master of Business Administration (Full-Time)", "professional", "Business Administration"),
...
_PROGRAM_KEYWORDS_BY_SLUG: dict[str, list[str]] = {
    "gatech-online-ms-computer-science-omscs": ["OMSCS", "online computer science", "computer science"],
...
_OUTCOMES_SRC_URL = (
    "https://academiceffectiveness.gatech.edu/surveys/reports/georgia-tech-career-survey-report-ay-2024-2025"
)
...
_REQ_UNDERGRAD = {
    "materials": [
        ...
        {"name": "$75 application fee (in-state) / $85 (out-of-state); fee waivers available", "required": True},
        {
    ...
    "international": {
        ...
        "visa": _INTL_VISA,
        "sources": [
            {"label": "Georgia Tech Undergraduate Admission — First-Year", "url": "https://admission.gatech.edu/first-year/"}
        ],
    },
...
_REQ_MBA = {
    ...
    "international": {
        ...
        "visa": _INTL_VISA,
        "sources": [
            {"label": "Scheller College of Business — Full-Time MBA Admissions", "url": "https://www.scheller.gatech.edu/degree-programs/full-time-mba/"}
        ],
    },
...
_REQ_GRAD_GENERIC = {
    ...
    "international": {
        ...
        "visa": _INTL_VISA,
        "sources": [
            {"label": "Georgia Tech Graduate Education — Admissions", "url": "https://grad.gatech.edu/admissions"}
        ],
    },
...
def _requirements_for(spec: dict) -> dict:
    ...
    if slug in ("gatech-mba", "gatech-mba-global-business-executive", "gatech-mba-management-technology-executive"):
        return _REQ_MBA
...
_REVIEWS_BY_SLUG: dict[str, dict] = {
    "gatech-online-ms-computer-science-omscs": {
        ...
        "themes": [
            {"label": "Exceptional affordability and ROI", "sentiment": "positive", "detail": "The complete degree costs about $7,000 — a fraction of comparable online CS master's at peer schools — with no 'online' label on the diploma."},
            {"label": "Same credential, strong industry recognition", "sentiment": "positive", "detail": "Employers value the Georgia Tech CS name; alumni report roles at Google, Amazon, Microsoft, and Meta, and the program graduated 10,000+ alumni in its first decade."},
            {"label": "Flexibility for working professionals", "sentiment": "positive", "detail": "Fully asynchronous; students take one to three courses per term and have up to six years to finish, making it compatible with full-time work."},
            {"label": "Genuinely rigorous — high attrition", "sentiment": "caution", "detail": "Multiple reviewers note a graduation rate below 50% and 15–25 hours per week per course; it is not a credential mill and is not suited to everyone."},
            {"label": "Variable course quality and support", "sentiment": "mixed", "detail": "Course quality and TA responsiveness vary; students rely on the OMSCentral review site and large peer/Slack communities to choose courses and stay on track."},
        ],
        "sources": [
            {"label": "Forbes / OMSCS — program overview and cost", "url": "https://omscs.gatech.edu/"},
            {"label": "OMSCentral — student course reviews", "url": "https://www.omscentral.com/"},
            {"label": "The Wandering Engineer — comprehensive OMSCS review", "url": "https://thewanderingengineer.medium.com/georgia-tech-omscs-program-a-comprehensive-review-a588b570f4e4"},
        ],
    ...
    "gatech-online-ms-analytics": {
        ...
        "themes": [
            {"label": "Top-ranked at a fraction of the cost", "sentiment": "positive", "detail": "A top-5 analytics program for roughly $10,000–$13,000 total tuition; reviewers repeatedly cite ROI far above bootcamps and $50k+ peer programs."},
            {"label": "Breadth across computing, stats, and business", "sentiment": "positive", "detail": "Three tracks (Analytical Tools, Business Analytics, Computational Data Analytics) span machine learning, statistics, optimization, and business applications."},
            {"label": "Flexible and career-changing", "sentiment": "positive", "detail": "Self-paced and online; reviewers describe meaningful career transitions into analytics and ML roles, often with employer tuition support."},
            {"label": "Rigorous and self-directed", "sentiment": "caution", "detail": "Courses are demanding and require substantial independent learning; many courses need 14+ hours/week and the program has a high dropout rate."},
            {"label": "Less computing depth than OMSCS", "sentiment": "mixed", "detail": "Some reviewers aiming for ML-engineering roles note OMSA carries less core computing/systems content than OMSCS and choose accordingly."},
        ],
        "sources": [
            {"label": "Georgia Tech Professional Education — OMS Analytics", "url": "https://pe.gatech.edu/degrees/analytics"},
            {"label": "The Data Generalist — OMSA review", "url": "https://thedatageneralist.com/omsa-review/"},
            {"label": "EnjoyMachineLearning — OMS Analytics review", "url": "https://enjoymachinelearning.com/blog/georgia-tech-oms-analytics-review/"},
        ],
        "disclaimer": _REVIEWS_DISCLAIMER,
    },
    "gatech-mba": {
        ...
        "themes": [
            {"label": "Best-in-class career services", "sentiment": "positive", "detail": "The Jones MBA Career Center pairs each student with a coach and deep employer ties; Poets&Quants named it a 2025 best-in-class career-services program."},
            {"label": "Strong, resilient outcomes", "sentiment": "positive", "detail": "Class of 2024: 88.4% employed within three months at an average $146,260 and a $30,000 median signing bonus, after 96% / $154,679 for the Class of 2023."},
            {"label": "Business-meets-technology positioning", "sentiment": "positive", "detail": "Tech Square location and top-ranked specializations (Business Analytics #3, Information Systems #5, Operations #5) suit tech, consulting, and analytics careers."},
            {"label": "Smaller, more regional brand", "sentiment": "mixed", "detail": "At ~145 students the program is intimate but less nationally sprawling than top-10 brands, with placements concentrated in consulting, tech, and the Southeast."},
            {"label": "Market sensitivity", "sentiment": "caution", "detail": "Coverage of the Class of 2024 framed Scheller's dip to 88.4% as a 'canary in the coal mine' for a tougher national MBA hiring market."},
        ],
        "sources": [
            {"label": "Poets&Quants — Scheller College of Business profile", "url": "https://poetsandquants.com/school-profile/georgia-institute-of-technologys-scheller-college-of-business/"},
            {"label": "Poets&Quants — 2025 Best-in-Class Career Services: Scheller", "url": "https://poetsandquants.com/2025/11/18/2025-mba-best-in-class-award-for-career-services-georgia-tech-scheller/"},
            {"label": "Scheller — Full-Time MBA rises to No. 21 (U.S. News 2025)", "url": "https://www.scheller.gatech.edu/news/2025/georgia-tech-full-time-mba-no-21-evening-mba-no-10.html"},
        ],
        "disclaimer": _REVIEWS_DISCLAIMER,
    },
    "gatech-computer-science-bs": {
        ...
        "themes": [
            {"label": "Top-5 reputation and employer demand", "sentiment": "positive", "detail": "Ranked No. 5 for undergraduate CS by U.S. News; graduates are recruited heavily by major technology, finance, and aerospace employers."},
            {"label": "Flexible 'Threads' curriculum", "sentiment": "positive", "detail": "Students combine two of eight threads (e.g., Intelligence, Systems & Architecture, People) to tailor the degree to their goals."},
            {"label": "Strong experiential learning", "sentiment": "positive", "detail": "Georgia Tech's century-old co-op program and Atlanta tech ecosystem give CS students extensive internship and co-op access."},
            {"label": "Heavy workload and rigor", "sentiment": "caution", "detail": "Students describe a demanding, fast-paced curriculum where strong time management is essential."},
            {"label": "Scale and competition", "sentiment": "mixed", "detail": "As one of the largest CS programs in the country, popular courses are large and competitive, which some students find impersonal."},
        ],
        "sources": [
            {"label": "Georgia Tech — Rankings (U.S. News undergraduate CS No. 5)", "url": "https://www.gatech.edu/about/rankings"},
            {"label": "Georgia Tech College of Computing — BS in Computer Science", "url": "https://www.cc.gatech.edu/threads-better-way-learn-computing"},
        ],
        "disclaimer": _REVIEWS_DISCLAIMER,
    },
}
