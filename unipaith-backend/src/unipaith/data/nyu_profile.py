...
_DISAMBIG_NAMES: dict[str, str] = {
    ...
    # Real joint majors — name the two combined departments, not a space-mashed split form.
    "nyu-anthropology-classical-civilization-ba": "Bachelor of Arts in Anthropology and Classical Civilization",
    "nyu-anthropology-linguistics-ba": "Bachelor of Arts in Anthropology and Linguistics",
    # De-duplicate the redundant "— Physical/Occupational Therapy" echo; the post-professional
    # tracks are distinct programs for already-licensed clinicians.
    "nyu-physical-therapy-entry-level-dpt": "Doctor of Physical Therapy",
    "nyu-physical-therapy-practicing-physical-therapists-dpt": "Doctor of Physical Therapy (Post-Professional)",
...
_RESEARCHED_DESCRIPTIONS: dict[str, str] = {
    "nyu-chemistry-ba": "NYU's Bachelor of Arts in Chemistry builds a core in general, organic, and physical chemistry alongside mathematics and physics, while leaving roughly 26 elective credits open. That flexibility suits students pairing chemistry with a second major or a pre-health track, and undergraduates can join faculty research projects as early as their sophomore year.",
    "nyu-chemistry-bs": "The Bachelor of Science in Chemistry at NYU is the more intensive track, with a fuller required sequence in organic, inorganic, and physical chemistry and a mandatory eight-credit independent research project. Hands-on work in NYU's laboratories prepares graduates for doctoral study in chemistry or for medicine and dentistry.",
    "nyu-classics-ma": "NYU's Master of Arts in Classics covers Greek and Latin language, literature, history, archaeology, and ancient philosophy. Students complete survey sequences in Latin or Greek and demonstrate translation proficiency across a 32-credit program, building a foundation for doctoral work or for careers in teaching and cultural institutions.",
    "nyu-classics-phd": "Doctoral work in Classics at NYU covers seven fields — Greek and Roman literature, history, and archaeology, and Greek and Roman thought — and culminates in an original dissertation. Students draw on a consortial agreement with the City University of New York and Fordham University and on NYU-sponsored excavations in Egypt, Turkey, Cyprus, and Greece, combining rigorous philological training with interdisciplinary methods.",
    "nyu-european-mediterranean-studies-ba": "NYU's Bachelor of Arts in European and Mediterranean Studies takes an interdisciplinary approach to Europe's politics, culture, and society, letting students shape coursework around their interests. The major requires nine courses spanning European history, culture, and the social sciences, proficiency in a European language beyond the intermediate level, and at least one semester of study abroad, typically in the junior year.",
    "nyu-european-mediterranean-studies-ma": "The Master of Arts in European and Mediterranean Studies draws on the social sciences and humanities for students seeking an advanced understanding of Europe. Students build expertise across history, political science, and cultural studies while focusing on regions such as the European Union, Eastern Europe, or the Mediterranean, preparing for careers in public service, international business, law, media, and education, or for doctoral study.",
    "nyu-mathematics-ms": "NYU Courant's Master of Science in Mathematics grounds students in analysis, linear algebra, and complex variables before moving to specialized subjects such as probability, ordinary and partial differential equations, algebra, applied mathematics, and financial mathematics. Consistently ranked first nationally in applied mathematics, the department prepares graduates for roles in research, finance, engineering, and government, including portfolio analysis, statistical modeling, and numerical simulation.",
    "nyu-mathematics-phd": "The PhD in Mathematics at NYU's Courant Institute centers on dissertation research, with particular strength in applied mathematics, numerical simulation, and computational modeling for problems in climate, energy, and risk. Doctoral students pass written comprehensive examinations in advanced calculus, complex variables, and linear algebra and oral preliminary examinations before advancing to a dissertation defended before a faculty panel.",
    "nyu-physics-ba": "NYU's Bachelor of Arts in Physics requires eighteen courses in physics and mathematics, leaving substantial room for electives and a second major. Students master core areas — mechanics, electromagnetism, quantum mechanics, and thermal physics — within a flexible structure that supports broad engagement with the liberal arts.",
    "nyu-physics-bs": "The Bachelor of Science in Physics at NYU is the more rigorous track, adding computational physics, a full year of general chemistry, and a sequence of introductory, intermediate, and advanced laboratory courses. With advanced mathematics through mathematical physics and substantial lab and research experience, the BS prepares students specifically for graduate study in physics.",
    "nyu-physics-ms": "NYU's Master of Science in Physics requires mastery of core graduate courses in statistical physics, electromagnetism, computational physics, classical and quantum mechanics, and advanced experimental physics. Students concentrate in areas such as astrophysics and cosmology, condensed matter, elementary particle physics, quantum optics, or statistical physics, completing the degree through a research thesis, a literature report, or a comprehensive examination.",
    "nyu-physics-phd": "Doctoral research in Physics at NYU spans astrophysics and cosmology, atomic and molecular physics, condensed matter physics, elementary particle physics, quantum field theory and string theory, quantum optics, and statistical physics. Students enter dissertation work after an oral qualifying examination and defend their thesis before a committee, supported by weekly seminars, colloquia, and journal clubs across the department's subfields.",
    "nyu-italian-studies-ma": "NYU's Master of Arts in Italian Studies trains graduate students in Italian literature and cultural history through graduate seminars and a master's thesis. Faculty strengths span medieval and Renaissance studies, twentieth-century literature, film, and postmodern Italy, and students draw on NYU resources including Casa Italiana in New York and Villa La Pietra in Florence.",
    "nyu-italian-studies-phd": "The PhD in Italian Studies at NYU covers Italian literature and culture across four periods, from 1200 to the present, equipping students with expertise from the medieval era to contemporary works. Doctoral candidates progress through written examinations, a prospectus defense, and a dissertation of original research defended before a faculty committee, drawing on Casa Italiana, one of New York's most active Italian cultural centers.",
    "nyu-mechanical-engineering-ms": "NYU Tandon's Master of Science in Mechanical Engineering offers three specializations — controls and dynamic systems, fluids and energy engineering, and mechanics and structural systems — across a 30-credit curriculum. Advanced coursework spans robotics and mechatronics, computational fluid mechanics, additive manufacturing, composite materials, and control theory, preparing graduates for roles in manufacturing, aerospace, and energy systems.",
    "nyu-mechanical-engineering-phd": "The PhD in Mechanical Engineering at NYU Tandon supports dissertation research across five areas — aerospace engineering, controls and dynamic systems, fluid dynamics and thermal systems, materials engineering, and mechanics and structural systems. Doctoral students complete coursework grounded in theory and experiment, pass a qualifying examination within two years, and pursue an independent dissertation.",
    "nyu-chemical-engineering-ms": "NYU Tandon's Master of Science in Chemical Engineering builds on core graduate courses in transport phenomena, chemical engineering thermodynamics, reactor analysis and design, and applied mathematics, with a guided-studies or thesis pathway across 30 credits. Research spans complex fluids, nanomaterials, biopolymers and biosensors, process-systems engineering, and protein engineering, preparing graduates for chemical manufacturing, biotechnology, pharmaceuticals, and environmental engineering.",
    "nyu-chemical-engineering-phd": "The PhD in Chemical Engineering at NYU Tandon develops expert command of the field's fundamentals — transport phenomena, thermodynamics, and reactor analysis — alongside advanced study in its molecular and biomolecular subfields. Doctoral students pass a comprehensive qualifying examination and complete an original dissertation, advancing research that bridges the molecular and medical sciences.",
    "nyu-data-science-ba": "The Data Science major provides rigorous training in statistical modeling, machine learning, and data-driven reasoning, grounded in computer science and mathematics. Students develop both theoretical understanding and practical skills in programming, data analysis, and modern statistical methods, and pair the major with a College of Arts and Science minor to apply data science across domains, with attention to ethics and the distinction between causal inference and prediction.",
    "nyu-computer-data-science-ba": "The Computer and Data Science major integrates the full Data Science curriculum with the Computer Science curriculum. Students develop strong foundations in statistical modeling, machine learning, and data-driven reasoning, alongside advanced coursework in algorithms and computer systems, emphasizing computational methods and scalable system design that prepare them to build and deploy data-driven systems and engage with the computational foundations of artificial intelligence.",
    "nyu-data-science-mathematics-ba": "The Data Science and Mathematics major integrates the full Data Science curriculum with the Mathematics curriculum. Students develop strong foundations in statistical modeling, machine learning, and data-driven reasoning, alongside advanced coursework in probability and statistics, emphasizing theoretical foundations and mathematical rigor that prepare them for technically demanding roles and for graduate study in data science, statistics, and related fields.",
    "nyu-mathematics-finance-ms": "NYU Courant's Master of Science in Mathematics in Finance trains students in quantitative finance through courses on financial securities and markets, stochastic calculus and dynamic asset pricing, and risk and portfolio management, alongside computational methods in Python. Graduates build expertise in algorithmic trading, statistical arbitrage, and financial machine learning, with capstone projects carried out alongside industry professionals, preparing them for quantitative roles in investment management and trading.",
    "nyu-history-phd": "NYU's doctoral program in History trains students across eleven major fields, including Africa, East Asia, medieval and modern Europe, Latin America, South Asia, and the United States, with an optional concentration in Medieval and Renaissance Studies. Doctoral candidates combine broad coverage of a general area with intensive specialization in a primary field, a written qualifying examination across three fields, and a dissertation grounded in archival research, preparing for careers as historians and teachers.",
    "nyu-sport-management-bs": "This degree prepares students for careers in the multibillion-dollar international business of sports. Students gain the professional expertise to lead and promote sports organizations, develop and manage arenas and stadiums, and produce major sporting and entertainment events.",
    "nyu-higher-education-administration-edd": "The EdD program in Higher Education Administration is a part-time cohort program that uses research to inform professional practice, anchored in an extensive program of coursework in higher and postsecondary education. It is designed to meet the growing need for visionary and entrepreneurial leaders in community colleges, four-year colleges and universities, corporate-sponsored education, and governmental agencies.",
    "nyu-food-studies-ma": "The MA program in Food Studies employs approaches from the humanities and social sciences to examine how individuals, communities, and societies produce, distribute, and consume food. Students analyze cultural, political, economic, environmental, and geographic dimensions of food within local, urban, and global contexts, with electives addressing critical issues such as immigration, equity, and climate change, and New York City anchoring student and faculty investigations.",
    "nyu-performing-arts-administration-ma": "The Master of Arts program in Performing Arts Administration, founded in 1971, is one of the oldest and most respected arts administration programs in the country. It educates prospective and practicing administrators for positions with performing arts organizations in the United States and abroad, and a required internship places students with leading arts managers at organizations such as the Metropolitan Opera, Orpheus Chamber Orchestra, New York City Ballet, The Nederlander Organization, and Carnegie Hall.",
    "nyu-educational-theatre-colleges-communities-phd": "This research-based PhD program in Educational Theatre is designed for individuals who intend to pursue positions as academics, researchers, scholars, curriculum developers, and educational consultants. Doctoral studies provide comprehensive research and artistic training so that graduates can make a significant impact on scholarship in educational theatre, building a foundation in education, cognate study, research electives, and a specialized research methodology while developing expertise in a chosen area of specialization.",
    "nyu-media-culture-communication-phd": "The PhD program in Media, Culture, and Communication pursues interdisciplinary, theoretically sophisticated, multi-methodological, historical, and comparative approaches to the study of media and culture. Five research areas frame inquiry across the department — global communication and media; technology and society; visual culture and sound studies; media industries and politics; and interaction and experience — and doctoral students present original work at the department's annual Neil Postman Graduate Conference.",
    "nyu-accounting-ms": "The Master of Science in Accounting at NYU's Stern School of Business is a one-year program that prepares students to sit for New York State's Certified Public Accountant (CPA) examination. Coursework, taught at Stern's Greenwich Village campus, covers financial and managerial accounting, taxation, auditing, and the analytical skills required for professional practice.",
    "nyu-civil-engineering-ms": "NYU Tandon's Master of Science in Civil Engineering lets students specialize in one of six tracks — construction management, structural engineering, geotechnical engineering, environmental and water resources engineering, urban systems engineering, and highway and traffic engineering — or take courses across all six. The 30-credit curriculum pairs core work in infrastructure materials, project management, and risk analysis with eighteen elective credits, developing the expertise to design and analyze infrastructure in professional practice.",
    "nyu-industrial-engineering-ms": "NYU Tandon's Master of Science in Industrial Engineering is a U.S. News-ranked program focused on preparing students for organizational leadership roles. It combines a strong academic foundation with an emphasis on application, taught by professors with significant industry experience through project-based, practical courses that apply classroom principles to the challenges of helping organizations grow and improve.",
    "nyu-adult-gerontology-acute-care-nurse-practitioner-dnp": "This Doctor of Nursing Practice specialization prepares graduates to deliver advanced clinical care to acutely and critically ill adult and older-adult patients, with coursework in geriatric syndromes, acute care management, and clinical pharmacotherapeutics. At the doctoral level it develops organizational systems leaders in practice innovation, quality, and safety who translate evidence into practice and lead interprofessional teams.",
    "nyu-adult-gerontology-primary-care-nurse-practitioner-dnp": "This Doctor of Nursing Practice specialization prepares graduates to provide primary care to adults and older adults across the lifespan, with coursework in geriatric syndromes and adult-gerontology primary care. At the doctoral level it develops clinical scholars and organizational systems leaders skilled in evidence-based practice, healthcare policy, informatics, and quality improvement.",
    "nyu-family-nurse-practitioner-dnp": "This Doctor of Nursing Practice specialization prepares family nurse practitioners to provide primary care across the entire lifespan, with clinical coursework spanning infant and child health, women's health, and adult-gerontology care of families. The doctoral curriculum builds leadership competencies in healthcare policy, informatics, business and finance, and quality improvement.",
    "nyu-nurse-midwifery-dnp": "This Doctor of Nursing Practice specialization prepares nurse-midwives to manage prenatal, birth, gynecologic, and primary care for women through extensive clinical practica. At the doctoral level, graduates serve as clinical scholars and organizational systems leaders who advance evidence-based innovation, quality improvement, and health policy.",
    "nyu-pediatric-nurse-practitioner-dnp": "This Doctor of Nursing Practice specialization prepares pediatric nurse practitioners to provide primary care from infancy through adolescence, with coursework in pediatric assessment, pharmacotherapeutics, and primary care practice. The doctoral curriculum develops organizational systems leaders skilled in evidence-based practice, health policy, and interprofessional team leadership.",
...
def _nyu_description(spec: dict) -> str:
    ...
    When a slug carries a hand-authored, per-credential researched body in
    ``_RESEARCHED_DESCRIPTIONS`` (REPAIR_BACKLOG CRITICAL #2 — frame-shared field bodies +
    scrape-debris), that text wins verbatim: the bulletin scrape reused one department
    paragraph across a field's BA/BS/MS/PhD rows (a shared body the disambiguator could not
    split) and left raw catalogue debris (contact blocks, colon-truncated requirement lists)
    in others. Each override is researched per-program from that program's own NYU Bulletin
    page, distinct across credential levels, and free of debris tells.
    """
    from unipaith.data.nyu_bulletin_descriptions import BULLETIN_DESCRIPTIONS

    slug = spec["slug"]
    override = _RESEARCHED_DESCRIPTIONS.get(slug)
    if override is not None:
        clause = _sanitize_anti_stub_tells(override)
    else:
