...
FIELD_DESCRIPTIONS: dict[str, str] = {
    ...
    "Engineering, Other": (
        "Specialized engineering topics and interdisciplinary design projects across Stanford's college of engineering research ecosystem."
    ),
...
SLUG_DESCRIPTIONS: dict[str, str] = {
    "stanford-aa-ms": (
        "Aeronautics and astronautics graduate training covers spacecraft design, controls, and propulsion with ties to NASA Ames and Stanford's autonomous-systems research."
    ),
    "stanford-bioe-bs": (
        "Undergraduate bioengineering integrates device design, biomaterials, and physiology at the interface of engineering and Stanford Medicine."
    ),
    "stanford-cee-ms": (
        "Civil and environmental engineering graduate study spans structures, geotechnics, and sustainable water systems at the Stanford Doerr School of Sustainability."
    ),
    "stanford-cs-bs": (
        "Stanford's most popular undergraduate major covers algorithms, systems, AI, and theory through the School of Engineering's Computer Science department."
    ),
    "stanford-cs-ms": (
        "Stanford's flexible 45-unit M.S. in Computer Science spans ten official specializations — including AI, systems, theory, and HCI — with research ties to the Stanford AI Lab."
    ),
    "stanford-cs-phd": (
        "A fully funded doctoral program producing researchers in theory, systems, AI, and human-computer interaction across Stanford CS and affiliated labs."
    ),
    "stanford-earth-systems-bs": (
        "Earth Systems integrates geology, ecology, and environmental policy in the Stanford Doerr School of Sustainability's interdisciplinary undergraduate major."
    ),
    "stanford-economics-bs": (
        "Undergraduate economics at Stanford covers micro, macro, econometrics, and policy with the Stanford Institute for Economic Policy Research."
    ),
    "stanford-economics-phd": (
        "Doctoral economics at Stanford trains scholars in theory, empirical micro, and macroeconomics with the Stanford Institute for Economic Policy Research."
    ),
    "stanford-education-ms": (
        "Stanford GSE master's programs span learning design, education policy, and teacher preparation with Silicon Valley school and ed-tech partnerships."
    ),
    "stanford-education-phd": (
        "Doctoral study at the Graduate School of Education covers learning sciences, policy analysis, and economics of education with the Stanford Accelerator for Learning."
    ),
    "stanford-ee-ms": (
        "The M.S. in Electrical Engineering spans integrated circuits, photonics, signal processing, and information systems in the Stanford School of Engineering."
    ),
    "stanford-energy-science-engineering-ms": (
        "Energy Science and Engineering graduate study covers the energy transition, carbon capture, and grid systems within the Doerr School of Sustainability."
    ),
    "stanford-english-bs": (
        "English and creative writing at Stanford spans literary history, criticism, and workshop-based fiction and poetry through the Creative Writing Program."
    ),
    "stanford-gsb-phd": (
        "The GSB doctoral program trains future business-school faculty in finance, organizational behavior, marketing, and operations research."
    ),
    "stanford-human-biology-bs": (
        "Human Biology integrates life sciences, health policy, and social context — a Stanford interdisciplinary major bridging biology and society."
    ),
    "stanford-international-relations-bs": (
        "International relations combines security studies, political economy, and area expertise through Stanford's Center for International Security and Cooperation."
    ),
    "stanford-jd": (
        "Stanford Law School's three-year J.D. emphasizes law, technology, and policy with clinics in intellectual property, criminal defense, and international law."
    ),
    "stanford-mathematics-bs": (
        "Undergraduate mathematics spans pure and applied study with undergraduate research in the Department of Mathematics and ICME."
    ),
    "stanford-mba": (
        "The Stanford MBA is a two-year, full-time general-management program emphasizing entrepreneurship, innovation, and Silicon Valley venture networks."
    ),
    "stanford-md": (
        "Stanford Medicine's M.D. program pairs clinical training with discovery science on a flexible-length schedule at Stanford Hospital and Lucile Packard Children's."
    ),
    "stanford-me-bs": (
        "Undergraduate mechanical engineering combines mechanics, thermofluids, and product design with hands-on prototyping in the School of Engineering."
    ),
    "stanford-me-ms": (
        "Graduate mechanical engineering at Stanford covers design, robotics, biomechanics, and energy systems with the Center for Design Research and autonomous-vehicle labs."
    ),
    "stanford-mse-ms": (
        "Management Science and Engineering combines optimization, analytics, and technology strategy — a signature Stanford program linking engineering and the GSB ecosystem."
    ),
    "stanford-msx": (
        "The MSx is a one-year, full-time master's for accomplished mid-career leaders seeking general-management training at the GSB."
    ),
    "stanford-political-science-bs": (
        "Political science undergraduates study American politics, comparative government, and political theory through the Freeman Spogli Institute network."
    ),
    "stanford-psychology-bs": (
        "Undergraduate psychology covers cognitive, social, developmental, and neuroscience foundations in one of the nation's top-ranked psychology departments."
    ),
    "stanford-symbolic-systems-bs": (
        "Symbolic Systems examines cognition, computation, language, and philosophy — Stanford's signature interdisciplinary major feeding AI and cognitive-science research."
    ),
}
