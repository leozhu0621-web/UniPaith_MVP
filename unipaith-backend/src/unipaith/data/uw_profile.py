...
SCHOOL_OUTCOMES: dict = {
    ...
    "demographics": {
        "white": 0.3319, "asian": 0.2742, "hispanic": 0.1032, "black": 0.0433,
        "two_or_more": 0.0821, "american_indian": 0.0033, "pacific_islander": 0.0034,
        "international": 0.1173, "unknown": 0.0414, "women": 0.5664,
    },
    ...
    "campus_life": {
        ...
        "resources": [
            ...
            {"name": "University of Washington Libraries", "url": "https://www.lib.washington.edu/"},
            {"name": "Henry Art Gallery", "url": "https://henryart.org/"},
            {"name": "Burke Museum of Natural History and Culture", "url": "https://www.burkemuseum.org/"},
...
_SCHOOL_META = [
    {'key': 'ARTSCI', 'name': 'College of Arts and Sciences', 'sort_order': 1, 'website': 'https://artsci.uw.edu/', 'leadership': 'Dianne Harris — Dean', 'research_centers': ['Division of the Arts', 'Division of the Humanities', 'Division of the Natural Sciences', 'Division of the Social Sciences', 'Paul G. Allen School of Computer Science & Engineering (CS undergraduate major)'], 'keywords': ['College of Arts and Sciences', 'Arts and Sciences', 'liberal arts']},
    {'key': 'BUILT', 'name': 'College of Built Environments', 'sort_order': 2, 'website': 'https://be.uw.edu/', 'leadership': 'Ken P. Yocom — Dean', 'research_centers': ['Department of Architecture', 'Department of Construction Management', 'Department of Landscape Architecture', 'Department of Real Estate', 'Department of Urban Design & Planning'], 'keywords': ['College of Built Environments', 'built environments', 'architecture', 'urban planning']},
    {'key': 'BUS', 'name': 'Michael G. Foster School of Business', 'sort_order': 3, 'website': 'https://foster.uw.edu/', 'leadership': 'Frank Hodge — Dean', 'research_centers': ['Department of Accounting', 'Department of Finance & Business Economics', 'Department of Marketing & International Business', 'Department of Information Systems & Operations Management', 'Department of Management & Organization'], 'keywords': ['Foster School of Business', 'Foster', 'business', 'MBA']},
    {'key': 'DENT', 'name': 'School of Dentistry', 'sort_order': 4, 'website': 'https://dental.washington.edu/', 'leadership': 'André V. Ritter — Dean', 'research_centers': ['Doctor of Dental Surgery (DDS) program', 'Department of Oral Health Sciences', 'Graduate specialty programs (orthodontics, periodontics, prosthodontics, endodontics)'], 'keywords': ['School of Dentistry', 'dentistry', 'DDS', 'dental']},
    {'key': 'EDUC', 'name': 'College of Education', 'sort_order': 5, 'website': 'https://education.uw.edu/', 'leadership': 'Mia Tuan — Dean', 'research_centers': ['Area of Curriculum & Instruction', 'Area of Educational Leadership & Policy Studies', 'Area of Learning Sciences & Human Development', 'Area of Measurement & Statistics', 'Area of School Psychology', 'Area of Special Education'], 'keywords': ['College of Education', 'education', 'teaching']},
    {'key': 'ENGR', 'name': 'College of Engineering', 'sort_order': 6, 'website': 'https://www.engr.uw.edu/', 'leadership': 'Nancy Allbritton — Dean', 'research_centers': ['Paul G. Allen School of Computer Science & Engineering', 'Department of Electrical & Computer Engineering', 'Department of Mechanical Engineering', 'William E. Boeing Department of Aeronautics & Astronautics', 'Department of Civil & Environmental Engineering', 'Department of Bioengineering', 'Department of Materials Science & Engineering'], 'keywords': ['College of Engineering', 'engineering', 'computer science', 'Allen School']},
    {'key': 'ENV', 'name': 'College of the Environment', 'sort_order': 7, 'website': 'https://environment.uw.edu/', 'leadership': 'Joel Thornton — Interim Dean', 'research_centers': ['School of Oceanography', 'School of Aquatic & Fishery Sciences', 'School of Environmental & Forest Sciences', 'Department of Atmospheric & Climate Science', 'Department of Earth & Space Sciences'], 'keywords': ['College of the Environment', 'environment', 'oceanography', 'earth sciences']},
    {'key': 'ISCHOOL', 'name': 'The Information School', 'sort_order': 8, 'website': 'https://ischool.uw.edu/', 'leadership': 'Anind Dey — Dean', 'research_centers': ['Master of Library & Information Science (MLIS)', 'Master of Science in Information Management (MSIM)', 'Informatics undergraduate program', 'Ph.D. in Information Science'], 'keywords': ['The Information School', 'iSchool', 'information science', 'library and information science']},
    {'key': 'GRAD', 'name': 'The Graduate School', 'sort_order': 9, 'website': 'https://grad.uw.edu/', 'leadership': 'Joy Williamson-Lott — Dean', 'research_centers': ['Interdisciplinary graduate degree programs', 'Molecular Engineering & Sciences', 'Neuroscience', 'Molecular & Cellular Biology', 'Data Science', 'Individual PhD Program'], 'keywords': ['Graduate School', 'interdisciplinary', 'graduate program']},
    {'key': 'LAW', 'name': 'School of Law', 'sort_order': 10, 'website': 'https://www.law.uw.edu/', 'leadership': 'Tamara F. Lawson — Dean', 'research_centers': ['Juris Doctor (J.D.) program', 'Master of Laws (LL.M.) program', 'Master of Jurisprudence program', 'Ph.D. in Law program'], 'keywords': ['School of Law', 'law', 'J.D.', 'Juris Doctor']},
    {'key': 'MED', 'name': 'School of Medicine', 'sort_order': 11, 'website': 'https://www.uwmedicine.org/school-of-medicine', 'leadership': 'Timothy H. Dellit — Dean', 'research_centers': ['Doctor of Medicine (M.D.) program (WWAMI)', 'Department of Biochemistry', 'Department of Genome Sciences', 'Department of Immunology', 'Department of Rehabilitation Medicine', 'Department of Laboratory Medicine & Pathology'], 'keywords': ['School of Medicine', 'UW Medicine', 'medicine', 'WWAMI', 'M.D.']},
    {'key': 'NURS', 'name': 'School of Nursing', 'sort_order': 12, 'website': 'https://nursing.uw.edu/', 'leadership': 'Hilaire Thompson — Executive Dean', 'research_centers': ['Doctor of Nursing Practice (DNP) program', 'Master of Nursing program', 'Ph.D. in Nursing Science program'], 'keywords': ['School of Nursing', 'nursing', 'DNP']},
    {'key': 'PHARM', 'name': 'School of Pharmacy', 'sort_order': 13, 'website': 'https://sop.washington.edu/', 'leadership': 'Jay Panyam — Dean', 'research_centers': ['Doctor of Pharmacy (PharmD) program', 'Department of Pharmaceutics', 'Department of Medicinal Chemistry', 'Department of Pharmacy (pharmaceutical outcomes research & policy)'], 'keywords': ['School of Pharmacy', 'pharmacy', 'PharmD', 'pharmaceutics']},
    {'key': 'EVANS', 'name': 'Daniel J. Evans School of Public Policy and Governance', 'sort_order': 14, 'website': 'https://evans.uw.edu/', 'leadership': 'Jodi Sandfort — Dean', 'research_centers': ['Master of Public Administration (MPA) program', 'Executive Master of Public Administration program', 'Ph.D. in Public Policy & Management program'], 'keywords': ['Evans School', 'public policy', 'public administration', 'MPA']},
    {'key': 'PUBH', 'name': 'School of Public Health', 'sort_order': 15, 'website': 'https://sph.washington.edu/', 'leadership': 'Hilary Godwin — Dean', 'research_centers': ['Department of Biostatistics', 'Department of Epidemiology', 'Department of Environmental & Occupational Health Sciences', 'Department of Health Systems & Population Health', 'Department of Global Health'], 'keywords': ['School of Public Health', 'public health', 'epidemiology', 'biostatistics', 'global health']},
    {'key': 'SOCW', 'name': 'School of Social Work', 'sort_order': 16, 'website': 'https://socialwork.uw.edu/', 'leadership': 'Michael S. Spencer — Dean', 'research_centers': ['Bachelor of Arts in Social Welfare program', 'Master of Social Work (MSW) program', 'Ph.D. in Social Welfare program'], 'keywords': ['School of Social Work', 'social work', 'MSW']},
]
...
_CATALOG: list[tuple] = [
    ('uw-american-ethnic-studies-bs', 'ARTSCI', 'American Ethnic Studies', 'bachelors', 'American Ethnic Studies', 'on_campus', 48),
    ('uw-american-indian-studies-bs', 'ARTSCI', 'American Indian Studies', 'bachelors', 'American Indian Studies', 'on_campus', 48),
    ('uw-american-music-bs', 'ARTSCI', 'American Music', 'bachelors', 'American Music', 'on_campus', 48),
    ('uw-anthropology-bs', 'ARTSCI', 'Anthropology', 'bachelors', 'Anthropology', 'on_campus', 48),
    ('uw-applied-and-computational-math-sciences-bs', 'ARTSCI', 'Applied and Computational Math Sciences', 'bachelors', 'Applied and Computational Math Sciences', 'on_campus', 48),
    ('uw-applied-mathematics-bs', 'ARTSCI', 'Applied Mathematics', 'bachelors', 'Applied Mathematics', 'on_campus', 48),
    ('uw-art-bs', 'ARTSCI', 'Art', 'bachelors', 'Art', 'on_campus', 48),
    ('uw-art-history-bs', 'ARTSCI', 'Art History', 'bachelors', 'Art History', 'on_campus', 48),
    ('uw-asian-languages-and-cultures-bs', 'ARTSCI', 'Asian Languages and Cultures', 'bachelors', 'Asian Languages and Cultures', 'on_campus', 48),
    ...
    ('uw-cinema-and-media-studies-bs', 'ARTSCI', 'Cinema and Media Studies', 'bachelors', 'Cinema and Media Studies', 'on_campus', 48),
    ('uw-classical-studies-bs', 'ARTSCI', 'Classical Studies', 'bachelors', 'Classical Studies', 'on_campus', 48),
    ('uw-classics-bs', 'ARTSCI', 'Classics', 'bachelors', 'Classics', 'on_campus', 48),
    ('uw-communication-bs', 'ARTSCI', 'Communication', 'bachelors', 'Communication', 'on_campus', 48),
    ('uw-comparative-history-of-ideas-bs', 'ARTSCI', 'Comparative History of Ideas', 'bachelors', 'Comparative History of Ideas', 'on_campus', 48),
    ('uw-comparative-literature-bs', 'ARTSCI', 'Comparative Literature', 'bachelors', 'Comparative Literature', 'on_campus', 48),
    ('uw-comparative-religion-bs', 'ARTSCI', 'Comparative Religion', 'bachelors', 'Comparative Religion', 'on_campus', 48),
    ('uw-composition-bs', 'ARTSCI', 'Composition', 'bachelors', 'Composition', 'on_campus', 48),
    ('uw-computational-finance-and-risk-management-bs', 'ARTSCI', 'Computational Finance and Risk Management', 'bachelors', 'Computational Finance and Risk Management', 'on_campus', 48),
    ('uw-computer-science-bs', 'ARTSCI', 'Computer Science', 'bachelors', 'Computer Science', 'on_campus', 48),
    ...
    ('uw-eastern-european-languages-literature-and-culture-bs', 'ARTSCI', 'Eastern European Languages, Literature, and Culture', 'bachelors', 'Eastern European Languages, Literature, and Culture', 'on_campus', 48),
    ...
    ('uw-ethnomusicology-bs', 'ARTSCI', 'Ethnomusicology', 'bachelors', 'Ethnomusicology', 'on_campus', 48),
    ('uw-finnish-bs', 'ARTSCI', 'Finnish', 'bachelors', 'Finnish', 'on_campus', 48),
    ('uw-french-bs', 'ARTSCI', 'French', 'bachelors', 'French', 'on_campus', 48),
    ('uw-gender-women-and-sexuality-studies-bs', 'ARTSCI', 'Gender, Women, and Sexuality Studies', 'bachelors', 'Gender, Women, and Sexuality Studies', 'on_campus', 48),
    ('uw-geography-bs', 'ARTSCI', 'Geography', 'bachelors', 'Geography', 'on_campus', 48),
    ('uw-german-studies-bs', 'ARTSCI', 'German Studies', 'bachelors', 'German Studies', 'on_campus', 48),
    ('uw-global-literary-studies-bs', 'ARTSCI', 'Global Literary Studies', 'bachelors', 'Global Literary Studies', 'on_campus', 48),
    ...
    ('uw-history-and-philosophy-of-science-bs', 'ARTSCI', 'History and Philosophy of Science', 'bachelors', 'History and Philosophy of Science', 'on_campus', 48),
    ('uw-individualized-studies-bs', 'ARTSCI', 'Individualized Studies', 'bachelors', 'Individualized Studies', 'on_campus', 48),
    ('uw-industrial-design-bs', 'ARTSCI', 'Industrial Design', 'bachelors', 'Industrial Design', 'on_campus', 48),
    ('uw-integrated-social-sciences-bs', 'ARTSCI', 'Integrated Social Sciences', 'bachelors', 'Integrated Social Sciences', 'online', 48),
    ('uw-interaction-design-bs', 'ARTSCI', 'Interaction Design', 'bachelors', 'Interaction Design', 'on_campus', 48),
    ('uw-international-studies-bs', 'ARTSCI', 'International Studies', 'bachelors', 'International Studies', 'on_campus', 48),
    ...
    ('uw-law-societies-and-justice-bs', 'ARTSCI', 'Law, Societies, and Justice', 'bachelors', 'Law, Societies, and Justice', 'on_campus', 48),
    ...
    ('uw-middle-eastern-languages-and-cultures-bs', 'ARTSCI', 'Middle Eastern Languages and Cultures', 'bachelors', 'Middle Eastern Languages and Cultures', 'on_campus', 48),
    ('uw-music-bs', 'ARTSCI', 'Music', 'bachelors', 'Music', 'on_campus', 48),
    ('uw-music-education-bs', 'ARTSCI', 'Music Education', 'bachelors', 'Music Education', 'on_campus', 48),
    ...
    ('uw-orchestral-instruments-bs', 'ARTSCI', 'Orchestral Instruments', 'bachelors', 'Orchestral Instruments', 'on_campus', 48),
    ...
    ('uw-political-science-bs', 'ARTSCI', 'Political Science', 'bachelors', 'Political Science', 'on_campus', 48),
    ('uw-psychology-bs', 'ARTSCI', 'Psychology', 'bachelors', 'Psychology', 'on_campus', 48),
    ('uw-romance-linguistics-bs', 'ARTSCI', 'Romance Linguistics', 'bachelors', 'Romance Linguistics', 'on_campus', 48),
    ('uw-russian-language-literature-and-culture-bs', 'ARTSCI', 'Russian Language, Literature, and Culture', 'bachelors', 'Russian Language, Literature, and Culture', 'on_campus', 48),
    ('uw-scandinavian-area-studies-bs', 'ARTSCI', 'Scandinavian Area Studies', 'bachelors', 'Scandinavian Area Studies', 'on_campus', 48),
    ('uw-sociology-bs', 'ARTSCI', 'Sociology', 'bachelors', 'Sociology', 'on_campus', 48),
    ('uw-south-asian-languages-and-cultures-bs', 'ARTSCI', 'South Asian Languages and Cultures', 'bachelors', 'South Asian Languages and Cultures', 'on_campus', 48),
    ('uw-spanish-bs', 'ARTSCI', 'Spanish', 'bachelors', 'Spanish', 'on_campus', 48),
    ('uw-speech-and-hearing-sciences-bs', 'ARTSCI', 'Speech and Hearing Sciences', 'bachelors', 'Speech and Hearing Sciences', 'on_campus', 48),
    ('uw-statistics-bs', 'ARTSCI', 'Statistics', 'bachelors', 'Statistics', 'on_campus', 48),
    ('uw-string-instruments-bs', 'ARTSCI', 'String Instruments', 'bachelors', 'String Instruments', 'on_campus', 48),
    ('uw-swedish-bs', 'ARTSCI', 'Swedish', 'bachelors', 'Swedish', 'on_campus', 48),
    ('uw-visual-communication-design-bs', 'ARTSCI', 'Visual Communication Design', 'bachelors', 'Visual Communication Design', 'on_campus', 48),
    ...
    ('uw-applied-chemical-science-and-technology-ms', 'ARTSCI', 'Applied Chemical Science and Technology', 'masters', 'Applied Chemical Science and Technology', 'on_campus', 24),
    ('uw-applied-child-and-adolescent-psychology-prevention-and-treatment-ms', 'ARTSCI', 'Applied Child and Adolescent Psychology: Prevention and Treatment', 'masters', 'Applied Child and Adolescent Psychology: Prevention and Treatment', 'on_campus', 24),
    ('uw-applied-mathematics-ms', 'ARTSCI', 'Applied Mathematics', 'masters', 'Applied Mathematics', 'online', 24),
    ('uw-art-history-ms', 'ARTSCI', 'Art History', 'masters', 'Art History', 'on_campus', 24),
    ('uw-asian-languages-and-literature-ms', 'ARTSCI', 'Asian Languages & Literature', 'masters', 'Asian Languages & Literature', 'on_campus', 24),
    ...
    ('uw-cinema-and-media-studies-ms', 'ARTSCI', 'Cinema and Media Studies', 'masters', 'Cinema and Media Studies', 'on_campus', 24),
    ('uw-communication-ms', 'ARTSCI', 'Communication', 'masters', 'Communication', 'on_campus', 24),
    ('uw-computational-finance-and-risk-management-ms', 'ARTSCI', 'Computational Finance & Risk Management', 'masters', 'Computational Finance & Risk Management', 'online', 24),
    ('uw-computational-linguistics-ms', 'ARTSCI', 'Computational Linguistics', 'masters', 'Computational Linguistics', 'online', 24),
    ...
    ('uw-east-asia-studies-ms', 'ARTSCI', 'East Asia Studies', 'masters', 'East Asia Studies', 'on_campus', 24),
    ('uw-economics-ms', 'ARTSCI', 'Economics', 'masters', 'Economics', 'on_campus', 24),
    ('uw-english-ms', 'ARTSCI', 'English', 'masters', 'English', 'on_campus', 24),
    ('uw-feminist-studies-ms', 'ARTSCI', 'Feminist Studies', 'masters', 'Feminist Studies', 'on_campus', 24),
    ...
    ('uw-german-studies-ms', 'ARTSCI', 'German Studies', 'masters', 'German Studies', 'on_campus', 24),
    ('uw-hispanic-studies-ms', 'ARTSCI', 'Hispanic Studies', 'masters', 'Hispanic Studies', 'on_campus', 24),
    ('uw-international-studies-ms', 'ARTSCI', 'International Studies', 'masters', 'International Studies', 'on_campus', 24),
    ('uw-italian-studies-ms', 'ARTSCI', 'Italian Studies', 'masters', 'Italian Studies', 'on_campus', 24),
    ...
    ('uw-near-eastern-languages-and-civilization-ms', 'ARTSCI', 'Near Eastern Languages & Civilization', 'masters', 'Near Eastern Languages & Civilization', 'on_campus', 24),
    ...
    ('uw-political-science-ms', 'ARTSCI', 'Political Science', 'masters', 'Political Science', 'on_campus', 24),
    ('uw-psychology-ms', 'ARTSCI', 'Psychology', 'masters', 'Psychology', 'on_campus', 24),
    ('uw-russia-east-european-and-central-asian-studies-ms', 'ARTSCI', 'Russia, East European and Central Asian Studies', 'masters', 'Russia, East European and Central Asian Studies', 'on_campus', 24),
    ('uw-scandinavian-ms', 'ARTSCI', 'Scandinavian', 'masters', 'Scandinavian', 'on_campus', 24),
    ('uw-slavic-languages-and-literatures-ms', 'ARTSCI', 'Slavic Languages & Literatures', 'masters', 'Slavic Languages & Literatures', 'on_campus', 24),
    ('uw-sociology-ms', 'ARTSCI', 'Sociology', 'masters', 'Sociology', 'on_campus', 24),
    ('uw-south-asian-studies-ms', 'ARTSCI', 'South Asian Studies', 'masters', 'South Asian Studies', 'on_campus', 24),
    ('uw-southeast-asian-studies-ms', 'ARTSCI', 'Southeast Asian Studies', 'masters', 'Southeast Asian Studies', 'on_campus', 24),
    ('uw-speech-language-pathology-ms', 'ARTSCI', 'Speech-Language Pathology', 'masters', 'Speech-Language Pathology', 'on_campus', 24),
    ...
    ('uw-applied-mathematics-phd', 'ARTSCI', 'Applied Mathematics', 'phd', 'Applied Mathematics', 'on_campus', 60),
    ('uw-art-history-phd', 'ARTSCI', 'Art History', 'phd', 'Art History', 'on_campus', 60),
    ('uw-asian-languages-and-literature-phd', 'ARTSCI', 'Asian Languages & Literature', 'phd', 'Asian Languages & Literature', 'on_campus', 60),
    ...
    ('uw-cinema-and-media-studies-phd', 'ARTSCI', 'Cinema and Media Studies', 'phd', 'Cinema and Media Studies', 'on_campus', 60),
    ('uw-communication-phd', 'ARTSCI', 'Communication', 'phd', 'Communication', 'on_campus', 60),
    ('uw-digital-arts-and-experimental-media-phd', 'ARTSCI', 'Digital Arts & Experimental Media', 'phd', 'Digital Arts & Experimental Media', 'on_campus', 60),
    ...
    ('uw-feminist-studies-phd', 'ARTSCI', 'Feminist Studies', 'phd', 'Feminist Studies', 'on_campus', 60),
    ...
    ('uw-hispanic-studies-phd', 'ARTSCI', 'Hispanic Studies', 'phd', 'Hispanic Studies', 'on_campus', 60),
    ...
    ('uw-near-and-middle-eastern-studies-phd', 'ARTSCI', 'Near & Middle Eastern Studies', 'phd', 'Near & Middle Eastern Studies', 'on_campus', 60),
    ('uw-philosophy-phd', 'ARTSCI', 'Philosophy', 'phd', 'Philosophy', 'on_campus', 60),
    ('uw-physics-phd', 'ARTSCI', 'Physics', 'phd', 'Physics', 'on_campus', 60),
    ('uw-political-science-phd', 'ARTSCI', 'Political Science', 'phd', 'Political Science', 'on_campus', 60),
    ...
    ('uw-slavic-languages-and-literatures-phd', 'ARTSCI', 'Slavic Languages & Literatures', 'phd', 'Slavic Languages & Literatures', 'on_campus', 60),
    ('uw-sociology-phd', 'ARTSCI', 'Sociology', 'phd', 'Sociology', 'on_campus', 60),
    ('uw-speech-and-hearing-sciences-phd', 'ARTSCI', 'Speech and Hearing Sciences', 'phd', 'Speech and Hearing Sciences', 'on_campus', 60),
    ('uw-statistics-phd', 'ARTSCI', 'Statistics', 'phd', 'Statistics', 'on_campus', 60),
    ('uw-architectural-design-bs', 'BUILT', 'Architectural Design', 'bachelors', 'Architectural Design', 'on_campus', 48),
    ('uw-architectural-design-w-const-mgmt-bs', 'BUILT', 'Architectural Design (w/Const Mgmt)', 'bachelors', 'Architectural Design (w/Const Mgmt)', 'on_campus', 48),
    ('uw-architectural-studies-bs', 'BUILT', 'Architectural Studies', 'bachelors', 'Architectural Studies', 'on_campus', 48),
    ('uw-community-environment-and-planning-bs', 'BUILT', 'Community, Environment, and Planning', 'bachelors', 'Community, Environment, and Planning', 'on_campus', 48),
    ('uw-environmental-design-and-sustainability-bs', 'BUILT', 'Environmental Design and Sustainability', 'bachelors', 'Environmental Design and Sustainability', 'on_campus', 48),
    ...
    ('uw-construction-management-ms', 'BUILT', 'Construction Management', 'masters', 'Construction Management', 'online', 24),
    ('uw-infrastructure-planning-and-management-ms', 'BUILT', 'Infrastructure Planning & Management', 'masters', 'Infrastructure Planning & Management', 'on_campus', 24),
    ('uw-infrastructure-planning-and-management-ms-2', 'BUILT', 'Infrastructure Planning & Management', 'masters', 'Infrastructure Planning & Management', 'online', 24),
    ('uw-landscape-architecture-ms', 'BUILT', 'Landscape Architecture', 'masters', 'Landscape Architecture', 'on_campus', 24),
    ('uw-real-estate-ms', 'BUILT', 'Real Estate', 'masters', 'Real Estate', 'on_campus', 24),
    ('uw-urban-planning-ms', 'BUILT', 'Urban Planning', 'masters', 'Urban Planning', 'on_campus', 24),
    ('uw-built-environment-phd', 'BUILT', 'Built Environment', 'phd', 'Built Environment', 'on_campus', 60),
    ('uw-urban-design-and-planning-phd', 'BUILT', 'Urban Design & Planning', 'phd', 'Urban Design & Planning', 'on_campus', 60),
    ('uw-accounting-bs', 'BUS', 'Accounting', 'bachelors', 'Accounting', 'on_campus', 48),
    ('uw-accounting-for-business-professionals-bs', 'BUS', 'Accounting for Business Professionals', 'bachelors', 'Accounting for Business Professionals', 'on_campus', 48),
    ('uw-entrepreneurship-bs', 'BUS', 'Entrepreneurship', 'bachelors', 'Entrepreneurship', 'on_campus', 48),
    ('uw-finance-bs', 'BUS', 'Finance', 'bachelors', 'Finance', 'on_campus', 48),
    ('uw-human-resources-management-bs', 'BUS', 'Human Resources Management', 'bachelors', 'Human Resources Management', 'on_campus', 48),
    ('uw-information-systems-bs', 'BUS', 'Information Systems', 'bachelors', 'Information Systems', 'on_campus', 48),
    ('uw-marketing-bs', 'BUS', 'Marketing', 'bachelors', 'Marketing', 'on_campus', 48),
    ('uw-operations-and-supply-chain-management-bs', 'BUS', 'Operations and Supply Chain Management', 'bachelors', 'Operations and Supply Chain Management', 'on_campus', 48),
    ('uw-business-administration-ms', 'BUS', 'Business Administration', 'masters', 'Business Administration', 'on_campus', 24),
    ('uw-business-analytics-ms', 'BUS', 'Business Analytics', 'masters', 'Business Analytics', 'on_campus', 24),
    ('uw-entrepreneurship-ms', 'BUS', 'Entrepreneurship', 'masters', 'Entrepreneurship', 'on_campus', 24),
    ('uw-information-systems-ms', 'BUS', 'Information Systems', 'masters', 'Information Systems', 'on_campus', 24),
    ('uw-professional-accounting-ms', 'BUS', 'Professional Accounting', 'masters', 'Professional Accounting', 'on_campus', 24),
    ('uw-supply-chain-management-ms', 'BUS', 'Supply Chain Management', 'masters', 'Supply Chain Management', 'on_campus', 24),
    ('uw-taxation-ms', 'BUS', 'Taxation', 'masters', 'Taxation', 'on_campus', 24),
    ('uw-business-administration-phd', 'BUS', 'Business Administration', 'phd', 'Business Administration', 'on_campus', 60),
    ...
    ('uw-oral-health-sciences-ms', 'DENT', 'Oral Health Sciences', 'masters', 'Oral Health Sciences', 'on_campus', 24),
    ...
    ('uw-prosthodontics-ms', 'DENT', 'Prosthodontics', 'masters', 'Prosthodontics', 'on_campus', 24),
    ...
    ('uw-oral-health-sciences-phd', 'DENT', 'Oral Health Sciences', 'phd', 'Oral Health Sciences', 'on_campus', 60),
    ('uw-early-care-and-education-bs', 'EDUC', 'Early Care and Education', 'bachelors', 'Early Care and Education', 'on_campus', 48),
    ('uw-early-care-and-education-fee-based-online-bs', 'EDUC', 'Early Care and Education (fee-based) (online)', 'bachelors', 'Early Care and Education (fee-based) (online)', 'on_campus', 48),
    ('uw-early-childhood-and-family-studies-bs', 'EDUC', 'Early Childhood and Family Studies', 'bachelors', 'Early Childhood and Family Studies', 'on_campus', 48),
    ('uw-education-studies-bs', 'EDUC', 'Education Studies', 'bachelors', 'Education Studies', 'on_campus', 48),
    ('uw-education-communities-and-organizations-bs', 'EDUC', 'Education, Communities and Organizations', 'bachelors', 'Education, Communities and Organizations', 'on_campus', 48),
    ('uw-curriculum-and-instruction-ms', 'EDUC', 'Curriculum & Instruction', 'masters', 'Curriculum & Instruction', 'on_campus', 24),
    ('uw-educational-foundations-leadership-and-policy-ms', 'EDUC', 'Educational Foundations, Leadership & Policy', 'masters', 'Educational Foundations, Leadership & Policy', 'on_campus', 24),
    ('uw-educational-leadership-and-policy-studies-ms', 'EDUC', 'Educational Leadership & Policy Studies', 'masters', 'Educational Leadership & Policy Studies', 'on_campus', 24),
    ('uw-learning-sciences-and-human-development-ms', 'EDUC', 'Learning Sciences & Human Development', 'masters', 'Learning Sciences & Human Development', 'on_campus', 24),
    ('uw-master-in-teaching-ms', 'EDUC', 'Master In Teaching', 'masters', 'Master In Teaching', 'on_campus', 24),
    ('uw-measurement-and-statistics-ms', 'EDUC', 'Measurement & Statistics', 'masters', 'Measurement & Statistics', 'on_campus', 24),
    ('uw-special-education-ms', 'EDUC', 'Special Education', 'masters', 'Special Education', 'on_campus', 24),
    ('uw-curriculum-and-instruction-phd', 'EDUC', 'Curriculum & Instruction', 'phd', 'Curriculum & Instruction', 'on_campus', 60),
    ('uw-education-curriculum-and-instruction-phd', 'EDUC', 'Education: Curriculum & Instruction', 'phd', 'Education: Curriculum & Instruction', 'on_campus', 60),
    ('uw-education-educ-leadershp-and-policy-st-phd', 'EDUC', 'Education: Educ Leadershp & Policy St', 'phd', 'Education: Educ Leadershp & Policy St', 'on_campus', 60),
    ('uw-education-learning-sciences-and-human-development-phd', 'EDUC', 'Education: Learning Sciences & Human Development', 'phd', 'Education: Learning Sciences & Human Development', 'on_campus', 60),
    ('uw-education-measurement-and-statistics-phd', 'EDUC', 'Education: Measurement & Statistics', 'phd', 'Education: Measurement & Statistics', 'on_campus', 60),
    ('uw-education-school-psychology-phd', 'EDUC', 'Education: School Psychology', 'phd', 'Education: School Psychology', 'on_campus', 60),
    ('uw-education-special-education-phd', 'EDUC', 'Education: Special Education', 'phd', 'Education: Special Education', 'on_campus', 60),
    ('uw-educational-leadership-and-policy-studies-phd', 'EDUC', 'Educational Leadership & Policy Studies', 'phd', 'Educational Leadership & Policy Studies', 'on_campus', 60),
    ('uw-special-education-phd', 'EDUC', 'Special Education', 'phd', 'Special Education', 'on_campus', 60),
    ('uw-engineering-bs', 'ENGR', 'Engineering', 'bachelors', 'Engineering', 'on_campus', 48),
    ('uw-aeronautics-and-astronautics-ms', 'ENGR', 'Aeronautics and Astronautics', 'masters', 'Aeronautics and Astronautics', 'on_campus', 24),
    ('uw-aerospace-engineering-ms', 'ENGR', 'Aerospace Engineering', 'masters', 'Aerospace Engineering', 'online', 24),
    ('uw-applied-bioengineering-ms', 'ENGR', 'Applied Bioengineering', 'masters', 'Applied Bioengineering', 'on_campus', 24),
    ('uw-artificial-intelligence-and-machine-learning-for-engineering-ms', 'ENGR', 'Artificial Intelligence and Machine Learning for Engineering', 'masters', 'Artificial Intelligence and Machine Learning for Engineering', 'on_campus', 24),
    ('uw-bioengineering-ms', 'ENGR', 'Bioengineering', 'masters', 'Bioengineering', 'on_campus', 24),
    ('uw-chemical-engineering-ms', 'ENGR', 'Chemical Engineering', 'masters', 'Chemical Engineering', 'on_campus', 24),
    ('uw-civil-engineering-ms', 'ENGR', 'Civil Engineering', 'masters', 'Civil Engineering', 'on_campus', 24),
    ('uw-computer-science-and-engineering-ms', 'ENGR', 'Computer Science & Engineering', 'masters', 'Computer Science & Engineering', 'on_campus', 24),
    ('uw-electrical-and-computer-engineering-ms', 'ENGR', 'Electrical and Computer Engineering', 'masters', 'Electrical and Computer Engineering', 'on_campus', 24),
    ('uw-engineering-in-leadership-and-systems-innovation-ms', 'ENGR', 'Engineering in Leadership and Systems Innovation', 'masters', 'Engineering in Leadership and Systems Innovation', 'on_campus', 24),
    ('uw-engineering-in-multidisciplinary-engineering-ms', 'ENGR', 'Engineering in Multidisciplinary Engineering', 'masters', 'Engineering in Multidisciplinary Engineering', 'on_campus', 24),
    ('uw-human-centered-design-and-engineering-ms', 'ENGR', 'Human Centered Design & Engineering', 'masters', 'Human Centered Design & Engineering', 'on_campus', 24),
    ('uw-industrial-and-systems-engineering-ms', 'ENGR', 'Industrial & Systems Engineering', 'masters', 'Industrial & Systems Engineering', 'on_campus', 24),
    ('uw-industrial-engineering-ms', 'ENGR', 'Industrial Engineering', 'masters', 'Industrial Engineering', 'on_campus', 24),
    ('uw-materials-science-and-engineering-ms', 'ENGR', 'Materials Science & Engineering', 'masters', 'Materials Science & Engineering', 'on_campus', 24),
    ('uw-materials-science-and-engineering-ms-2', 'ENGR', 'Materials Science and Engineering', 'masters', 'Materials Science and Engineering', 'on_campus', 24),
    ('uw-mechanical-engineering-ms', 'ENGR', 'Mechanical Engineering', 'masters', 'Mechanical Engineering', 'online', 24),
    ('uw-pharmaceutical-bioengineering-ms', 'ENGR', 'Pharmaceutical Bioengineering', 'masters', 'Pharmaceutical Bioengineering', 'online', 24),
    ('uw-supply-chain-transportation-and-logistics-ms', 'ENGR', 'Supply Chain Transportation & Logistics', 'masters', 'Supply Chain Transportation & Logistics', 'online', 24),
    ('uw-sustainable-transportation-ms', 'ENGR', 'Sustainable Transportation', 'masters', 'Sustainable Transportation', 'online', 24),
    ('uw-technology-innovation-ms', 'ENGR', 'Technology Innovation', 'masters', 'Technology Innovation', 'on_campus', 24),
    ('uw-aeronautics-and-astronautics-phd', 'ENGR', 'Aeronautics & Astronautics', 'phd', 'Aeronautics & Astronautics', 'on_campus', 60),
    ('uw-bioengineering-phd', 'ENGR', 'Bioengineering', 'phd', 'Bioengineering', 'on_campus', 60),
    ('uw-chemical-engineering-phd', 'ENGR', 'Chemical Engineering', 'phd', 'Chemical Engineering', 'on_campus', 60),
    ('uw-civil-engineering-phd', 'ENGR', 'Civil Engineering', 'phd', 'Civil Engineering', 'on_campus', 60),
    ('uw-computer-science-and-engineering-phd', 'ENGR', 'Computer Science & Engineering', 'phd', 'Computer Science & Engineering', 'on_campus', 60),
    ('uw-electrical-and-computer-engineering-phd', 'ENGR', 'Electrical and Computer Engineering', 'phd', 'Electrical and Computer Engineering', 'on_campus', 60),
    ('uw-industrial-engineering-phd', 'ENGR', 'Industrial Engineering', 'phd', 'Industrial Engineering', 'on_campus', 60),
    ('uw-materials-science-and-engineering-phd', 'ENGR', 'Materials Science & Engineering', 'phd', 'Materials Science & Engineering', 'on_campus', 60),
    ('uw-mechanical-engineering-phd', 'ENGR', 'Mechanical Engineering', 'phd', 'Mechanical Engineering', 'on_campus', 60),
    ('uw-aquatic-conservation-and-ecology-bs', 'ENV', 'Aquatic Conservation and Ecology', 'bachelors', 'Aquatic Conservation and Ecology', 'on_campus', 48),
    ('uw-atmospheric-and-climate-science-bs', 'ENV', 'Atmospheric and Climate Science', 'bachelors', 'Atmospheric and Climate Science', 'on_campus', 48),
    ('uw-earth-and-space-sciences-bs', 'ENV', 'Earth and Space Sciences', 'bachelors', 'Earth and Space Sciences', 'on_campus', 48),
    ('uw-environmental-science-and-terrestrial-resource-management-bs', 'ENV', 'Environmental Science and Terrestrial Resource Management', 'bachelors', 'Environmental Science and Terrestrial Resource Management', 'on_campus', 48),
    ('uw-environmental-studies-bs', 'ENV', 'Environmental Studies', 'bachelors', 'Environmental Studies', 'on_campus', 48),
    ('uw-marine-biology-bs', 'ENV', 'Marine Biology', 'bachelors', 'Marine Biology', 'on_campus', 48),
    ('uw-oceanography-bs', 'ENV', 'Oceanography', 'bachelors', 'Oceanography', 'on_campus', 48),
    ('uw-sustainable-bioresource-systems-engineering-bs', 'ENV', 'Sustainable Bioresource Systems Engineering', 'bachelors', 'Sustainable Bioresource Systems Engineering', 'on_campus', 48),
    ('uw-aquatic-and-fishery-sciences-ms', 'ENV', 'Aquatic & Fishery Sciences', 'masters', 'Aquatic & Fishery Sciences', 'on_campus', 24),
    ('uw-atmospheric-and-climate-science-ms', 'ENV', 'Atmospheric and Climate Science', 'masters', 'Atmospheric and Climate Science', 'on_campus', 24),
    ('uw-earth-and-space-sciences-ms', 'ENV', 'Earth & Space Sciences', 'masters', 'Earth & Space Sciences', 'on_campus', 24),
    ('uw-environmental-and-forest-sciences-ms', 'ENV', 'Environmental & Forest Sciences', 'masters', 'Environmental & Forest Sciences', 'on_campus', 24),
    ('uw-forest-resources-ms', 'ENV', 'Forest Resources', 'masters', 'Forest Resources', 'on_campus', 24),
    ...
    ('uw-quantitative-ecology-and-resource-management-ms', 'ENV', 'Quantitative Ecology & Resource Management', 'masters', 'Quantitative Ecology & Resource Management', 'on_campus', 24),
    ('uw-aquatic-and-fishery-sciences-phd', 'ENV', 'Aquatic & Fishery Sciences', 'phd', 'Aquatic & Fishery Sciences', 'on_campus', 60),
    ('uw-atmospheric-and-climate-science-phd', 'ENV', 'Atmospheric and Climate Science', 'phd', 'Atmospheric and Climate Science', 'on_campus', 60),
    ('uw-earth-and-space-sciences-phd', 'ENV', 'Earth & Space Sciences', 'phd', 'Earth & Space Sciences', 'on_campus', 60),
    ('uw-environmental-and-forest-sciences-phd', 'ENV', 'Environmental & Forest Sciences', 'phd', 'Environmental & Forest Sciences', 'on_campus', 60),
    ('uw-oceanography-phd', 'ENV', 'Oceanography', 'phd', 'Oceanography', 'on_campus', 60),
    ('uw-quantitative-ecology-and-resource-management-phd', 'ENV', 'Quantitative Ecology & Resource Management', 'phd', 'Quantitative Ecology & Resource Management', 'on_campus', 60),
    ('uw-information-management-ms', 'ISCHOOL', 'Information Management', 'masters', 'Information Management', 'online', 24),
    ('uw-information-science-ms', 'ISCHOOL', 'Information Science', 'masters', 'Information Science', 'on_campus', 24),
    ('uw-library-and-information-science-ms', 'ISCHOOL', 'Library & Information Science', 'masters', 'Library & Information Science', 'online', 24),
    ('uw-museology-ms', 'ISCHOOL', 'Museology', 'masters', 'Museology', 'on_campus', 24),
    ('uw-information-science-phd', 'ISCHOOL', 'Information Science', 'phd', 'Information Science', 'on_campus', 60),
    ('uw-data-science-ms', 'GRAD', 'Data Science', 'masters', 'Data Science', 'on_campus', 24),
    ('uw-human-computer-interaction-and-design-ms', 'GRAD', 'Human-Computer Interaction & Design', 'masters', 'Human-Computer Interaction & Design', 'on_campus', 24),
    ('uw-molecular-and-cellular-biology-ms', 'GRAD', 'Molecular & Cellular Biology', 'masters', 'Molecular & Cellular Biology', 'on_campus', 24),
    ('uw-molecular-engineering-ms', 'GRAD', 'Molecular Engineering', 'masters', 'Molecular Engineering', 'on_campus', 24),
    ...
    ('uw-molecular-and-cellular-biology-phd', 'GRAD', 'Molecular & Cellular Biology', 'phd', 'Molecular & Cellular Biology', 'on_campus', 60),
    ('uw-molecular-engineering-phd', 'GRAD', 'Molecular Engineering', 'phd', 'Molecular Engineering', 'on_campus', 60),
    ...
    ('uw-laws-in-taxation-ms', 'LAW', 'Laws In Taxation', 'masters', 'Laws In Taxation', 'on_campus', 24),
    ('uw-law-prof', 'LAW', 'Law', 'professional', 'Law', 'on_campus', 48),
    ('uw-law-phd', 'LAW', 'Law', 'phd', 'Law', 'on_campus', 60),
    ('uw-anatomic-pathology-ms', 'MED', 'Anatomic Pathology', 'masters', 'Anatomic Pathology', 'on_campus', 24),
    ...
    ('uw-biomedical-and-health-informatics-ms', 'MED', 'Biomedical & Health Informatics', 'masters', 'Biomedical & Health Informatics', 'on_campus', 24),
    ('uw-clinical-health-services-ms', 'MED', 'Clinical Health Services', 'masters', 'Clinical Health Services', 'on_campus', 24),
    ('uw-comparative-medicine-ms', 'MED', 'Comparative Medicine', 'masters', 'Comparative Medicine', 'on_campus', 24),
    ('uw-genetic-counseling-ms', 'MED', 'Genetic Counseling', 'masters', 'Genetic Counseling', 'on_campus', 24),
    ('uw-genome-sciences-ms', 'MED', 'Genome Sciences', 'masters', 'Genome Sciences', 'on_campus', 24),
    ('uw-health-metrics-sciences-ms', 'MED', 'Health Metrics Sciences', 'masters', 'Health Metrics Sciences', 'on_campus', 24),
    ('uw-immunology-ms', 'MED', 'Immunology', 'masters', 'Immunology', 'on_campus', 24),
    ('uw-laboratory-medicine-ms', 'MED', 'Laboratory Medicine', 'masters', 'Laboratory Medicine', 'on_campus', 24),
    ('uw-microbiology-ms', 'MED', 'Microbiology', 'masters', 'Microbiology', 'on_campus', 24),
    ('uw-molecular-medicine-and-mechanisms-of-disease-ms', 'MED', 'Molecular Medicine and Mechanisms of Disease', 'masters', 'Molecular Medicine and Mechanisms of Disease', 'on_campus', 24),
    ('uw-neurobiology-and-biophysics-ms', 'MED', 'Neurobiology and Biophysics', 'masters', 'Neurobiology and Biophysics', 'on_campus', 24),
    ('uw-occupational-therapy-ms', 'MED', 'Occupational Therapy', 'masters', 'Occupational Therapy', 'on_campus', 24),
    ('uw-pharmacology-ms', 'MED', 'Pharmacology', 'masters', 'Pharmacology', 'on_campus', 24),
    ('uw-prosthetics-and-orthotics-ms', 'MED', 'Prosthetics & Orthotics', 'masters', 'Prosthetics & Orthotics', 'on_campus', 24),
    ('uw-rehabilitation-medicine-ms', 'MED', 'Rehabilitation Medicine', 'masters', 'Rehabilitation Medicine', 'on_campus', 24),
    ('uw-medicine-prof', 'MED', 'Medicine', 'professional', 'Medicine', 'on_campus', 48),
    ('uw-physical-therapy-prof', 'MED', 'Physical Therapy', 'professional', 'Physical Therapy', 'on_campus', 48),
    ('uw-biochemistry-phd', 'MED', 'Biochemistry', 'phd', 'Biochemistry', 'on_campus', 60),
    ('uw-biomedical-and-health-informatics-phd', 'MED', 'Biomedical & Health Informatics', 'phd', 'Biomedical & Health Informatics', 'on_campus', 60),
    ('uw-genome-sciences-phd', 'MED', 'Genome Sciences', 'phd', 'Genome Sciences', 'on_campus', 60),
    ('uw-health-metrics-global-health-metrics-and-implementation-sciences-phd', 'MED', 'Health Metrics: Global Health Metrics & Implementation Sciences', 'phd', 'Health Metrics: Global Health Metrics & Implementation Sciences', 'on_campus', 60),
    ...
    ('uw-molecular-medicine-and-mechanisms-of-disease-phd', 'MED', 'Molecular Medicine and Mechanisms of Disease', 'phd', 'Molecular Medicine and Mechanisms of Disease', 'on_campus', 60),
    ('uw-neurobiology-and-biophysics-phd', 'MED', 'Neurobiology and Biophysics', 'phd', 'Neurobiology and Biophysics', 'on_campus', 60),
    ('uw-pharmacology-phd', 'MED', 'Pharmacology', 'phd', 'Pharmacology', 'on_campus', 60),
    ('uw-rehabilitation-science-phd', 'MED', 'Rehabilitation Science', 'phd', 'Rehabilitation Science', 'on_campus', 60),
    ('uw-nursing-ms', 'NURS', 'Nursing', 'masters', 'Nursing', 'on_campus', 24),
    ('uw-nursing-practice-prof', 'NURS', 'Nursing Practice', 'professional', 'Nursing Practice', 'on_campus', 48),
    ('uw-nursing-phd', 'NURS', 'Nursing', 'phd', 'Nursing', 'on_campus', 60),
    ('uw-biomedical-regulatory-affairs-ms', 'PHARM', 'Biomedical Regulatory Affairs', 'masters', 'Biomedical Regulatory Affairs', 'on_campus', 24),
    ('uw-health-economics-and-outcomes-research-ms', 'PHARM', 'Health Economics and Outcomes Research', 'masters', 'Health Economics and Outcomes Research', 'on_campus', 24),
    ('uw-medicinal-chemistry-ms', 'PHARM', 'Medicinal Chemistry', 'masters', 'Medicinal Chemistry', 'on_campus', 24),
    ...
    ('uw-health-economics-and-outcomes-research-phd', 'PHARM', 'Health Economics and Outcomes Research', 'phd', 'Health Economics and Outcomes Research', 'on_campus', 60),
    ('uw-medicinal-chemistry-phd', 'PHARM', 'Medicinal Chemistry', 'phd', 'Medicinal Chemistry', 'on_campus', 60),
    ('uw-pharmaceutics-phd', 'PHARM', 'Pharmaceutics', 'phd', 'Pharmaceutics', 'on_campus', 60),
    ('uw-public-service-and-policy-bs', 'EVANS', 'Public Service and Policy', 'bachelors', 'Public Service and Policy', 'on_campus', 48),
    ('uw-public-administration-ms', 'EVANS', 'Public Administration', 'masters', 'Public Administration', 'on_campus', 24),
    ('uw-public-policy-and-management-ms', 'EVANS', 'Public Policy & Management', 'masters', 'Public Policy & Management', 'on_campus', 24),
    ('uw-public-policy-and-management-phd', 'EVANS', 'Public Policy & Management', 'phd', 'Public Policy & Management', 'on_campus', 60),
    ('uw-environmental-public-health-bs', 'PUBH', 'Environmental Public Health', 'bachelors', 'Environmental Public Health', 'on_campus', 48),
    ('uw-food-systems-nutrition-and-health-bs', 'PUBH', 'Food Systems, Nutrition, and Health', 'bachelors', 'Food Systems, Nutrition, and Health', 'on_campus', 48),
    ('uw-public-health-global-health-bs', 'PUBH', 'Public Health-Global Health', 'bachelors', 'Public Health-Global Health', 'on_campus', 48),
    ('uw-biostatistics-ms', 'PUBH', 'Biostatistics', 'masters', 'Biostatistics', 'on_campus', 24),
    ('uw-environmental-health-sciences-ms', 'PUBH', 'Environmental Health Sciences', 'masters', 'Environmental Health Sciences', 'on_campus', 24),
    ('uw-epidemiology-ms', 'PUBH', 'Epidemiology', 'masters', 'Epidemiology', 'on_campus', 24),
    ('uw-genetic-epidemiology-ms', 'PUBH', 'Genetic Epidemiology', 'masters', 'Genetic Epidemiology', 'on_campus', 24),
    ('uw-global-health-ms', 'PUBH', 'Global Health', 'masters', 'Global Health', 'on_campus', 24),
    ('uw-health-administration-ms', 'PUBH', 'Health Administration', 'masters', 'Health Administration', 'online', 24),
    ('uw-health-informatics-and-health-information-management-ms', 'PUBH', 'Health Informatics & Health Information Management', 'masters', 'Health Informatics & Health Information Management', 'online', 24),
    ('uw-health-systems-and-population-health-ms', 'PUBH', 'Health Systems and Population Health', 'masters', 'Health Systems and Population Health', 'on_campus', 24),
    ('uw-nutritional-sciences-ms', 'PUBH', 'Nutritional Sciences', 'masters', 'Nutritional Sciences', 'on_campus', 24),
    ('uw-pathobiology-ms', 'PUBH', 'Pathobiology', 'masters', 'Pathobiology', 'on_campus', 24),
    ('uw-public-health-genetics-ms', 'PUBH', 'Public Health Genetics', 'masters', 'Public Health Genetics', 'on_campus', 24),
    ('uw-public-health-nutrition-ms', 'PUBH', 'Public Health Nutrition', 'masters', 'Public Health Nutrition', 'on_campus', 24),
    ('uw-biostatistics-phd', 'PUBH', 'Biostatistics', 'phd', 'Biostatistics', 'on_campus', 60),
    ('uw-environmental-health-sciences-phd', 'PUBH', 'Environmental Health Sciences', 'phd', 'Environmental Health Sciences', 'on_campus', 60),
    ('uw-epidemiology-phd', 'PUBH', 'Epidemiology', 'phd', 'Epidemiology', 'on_campus', 60),
    ('uw-global-health-global-health-metrics-and-implementation-sciences-phd', 'PUBH', 'Global Health: Global Health Metrics & Implementation Sciences', 'phd', 'Global Health: Global Health Metrics & Implementation Sciences', 'on_campus', 60),
    ('uw-health-services-phd', 'PUBH', 'Health Services', 'phd', 'Health Services', 'on_campus', 60),
    ('uw-nutritional-sciences-phd', 'PUBH', 'Nutritional Sciences', 'phd', 'Nutritional Sciences', 'on_campus', 60),
    ('uw-pathobiology-phd', 'PUBH', 'Pathobiology', 'phd', 'Pathobiology', 'on_campus', 60),
    ('uw-public-health-genetics-phd', 'PUBH', 'Public Health Genetics', 'phd', 'Public Health Genetics', 'on_campus', 60),
    ('uw-social-welfare-bs', 'SOCW', 'Social Welfare', 'bachelors', 'Social Welfare', 'on_campus', 48),
...
_DELIVERY_PHRASE = {"online": " It is delivered fully online through UW Professional & Continuing Education.", "hybrid": " It is delivered in a hybrid format."}
...
_PROGRAM_KEYWORDS_BY_SLUG: dict[str, list[str]] = {
    ...
    'uw-computer-science-and-engineering-ms': ['Paul G. Allen School', 'computer science', 'Allen School'],
    'uw-computer-science-and-engineering-phd': ['Paul G. Allen School', 'computer science', 'Allen School'],
...
_COST_SRC_URL = "https://collegescorecard.ed.gov/school/?236948-University-of-Washington-Seattle-Campus"
...
_REQ_GRAD_GENERIC = {
    ...
    "deadlines": [{"round": "Autumn admission", "date": "Deadlines vary by program (typically December–January)"}],
    "international": {
        "english": {"tests": ["TOEFL", "IELTS"], "required": True,
                    "note": "Required for applicants whose native language is not English."},
        "visa": _INTL_VISA,
        "sources": [{"label": "UW Graduate School — admissions", "url": "https://grad.uw.edu/admissions/"}],
    },
...
_REVIEWS_BY_SLUG: dict[str, dict] = {
  "uw-computer-science-bs": {
    ...
    "sources": [
      ...
      {
        "label": "UW News — U.S. News rankings",
  ...
  "uw-law-prof": {
    ...
    "sources": [
      {
        "label": "UW School of Law — J.D.",
        "url": "https://www.law.uw.edu/academics/jd"
      },
      {
        "label": "UW News — rankings",
        "url": "https://www.washington.edu/news/"
  ...
  "uw-bioengineering-ms": {
    ...
    "sources": [
      {
        "label": "UW Department of Bioengineering",
        "url": "https://bioe.uw.edu/"
      },
      {
        "label": "UW News — rankings",
        "url": "https://www.washington.edu/news/"
  ...
  "uw-statistics-bs": {
    ...
    "sources": [
      {
        "label": "UW Department of Statistics",
  ...
  "uw-economics-phd": {
    ...
    "sources": [
      {
        "label": "UW Department of Economics",
