...
FIELD_DESCRIPTIONS: dict[str, str] = {
    ...
    "Agricultural Business": (
        "CALS agricultural-business coursework covers farm management, commodity marketing, and agribusiness finance with Extension outreach across Wisconsin's dairy sector."
    ),
    "Agricultural Communication": (
        "Students in agricultural communication learn science journalism, extension messaging, and digital media for UW-Madison Extension and ag-industry audiences."
    ),
    "Agricultural Engineering": (
        "Engineering design for irrigation, precision agriculture, and biological systems drawing on UW-Madison's bioengineering and environmental-engineering labs."
    ),
    "Agricultural Mechanization": (
        "Agricultural mechanization at CALS trains students in precision agriculture, machinery systems, and on-farm technology at UW research stations."
    ),
    ...
    "Anthropology": (
        "Madison campus anthropology combines archaeological fieldwork, medical anthropology, and sociocultural theory with Madison and Wisconsin regional research sites."
    ),
    "Apparel and Textiles": (
        "Human Ecology fiber science and apparel design combines material testing, sustainable textiles, and industry partnerships through the UW-Madison Costume and Textile Collection."
    ),
    "Applied Mathematics": (
    ...
    "Biomedical Engineering": (
        "College of Engineering BME integrates engineering design with UW-Madison Hospital clinical immersion — U.S. News routinely ranks the undergraduate major #1 nationally."
    ),
    "Biotechnology": (
        "Graduate biotechnology coursework covers bioprocessing, regulatory science, and  translational research near the East Madison medical campus."
    ),
    "Business": (
        "Wisconsin School of Business foundations in accounting, analytics, and strategy with health-sector and real-estate case studies distinctive to the UW-Madison network."
    ),
    ...
    "Chemistry": (
        "College of Letters and Science chemistry runs synthesis, physical, and chemical-biology groups whose faculty hold joint appointments with the School of Medicine."
    ),
    "Civil Engineering": (
        "Civil and systems engineering at College of Engineering emphasizes infrastructure resilience, transportation systems, and urban hydrology."
    ),
    "Classical Studies": (
    ...
    "Computer Engineering": (
        "Electrical and computer engineering at College of Engineering covers embedded systems, VLSI, and hardware–software co-design with robotics lab access."
    ),
    "Computer Science": (
        "College of Engineering computer science covers algorithms, systems, AI, and theory with the Data Science and AI Institute and undergraduate research in robotics labs."
    ),
    "Computer and Information Sciences": (
        "Foundational CS spanning algorithms, systems, and AI within College of Engineering's Department of Computer Science and the Data Science and AI Institute."
    ),
    "Consumer Economics": (
        "Consumer economics in Human Ecology examines household finance, retail analytics, and financial counseling through the School of Human Ecology."
    ),
    "Criminology": (
    ...
    "Electrical Engineering": (
        "College of Engineering ECE spans signal processing, photonics, and medical devices with Malone Center for Engineering in Healthcare collaborations."
    ),
    "Engineering Mechanics": (
        "Engineering mechanics in the College of Engineering covers continuum mechanics, computational solid mechanics, and aerospace structures research."
    ),
    "Engineering Physics": (
        "Engineering physics at UW-Madison bridges applied physics, materials science, and quantum-device research in College of Engineering labs."
    ),
    "Engineering Studies": (
    ...
    "Ethnic Studies": (
        "Center for Africana Studies coursework examines race, diaspora, and social justice with Madison community-engaged research."
    ),
    "Experimental Psychology": (
        "Laboratory-based psychology at College of Letters and Science uses behavioral, cognitive, and neuroscience methods in the Psychological and Brain Sciences department."
    ),
    "Film Studies": (
        "Communication arts film production at Letters & Science covers cinematography, documentary filmmaking, and Wisconsin Film Festival industry connections."
    ),
    "Finance": (
        "Wisconsin School of Business finance coursework emphasizes health-care finance, real-estate valuation, and quantitative asset management."
    ),
    "Food Science": (
        "UW-Madison food science — among the nation's largest programs — covers food chemistry, processing, safety, and sensory evaluation in Whistler Hall labs."
    ),
    "Forestry": (
        "Forestry at the Nelson Institute and CALS examines forest ecology, timber management, and Wisconsin's northern hardwood ecosystems."
    ),
    "General Engineering": (
        "Undecided-engineering pathway at College of Engineering exposes students to design, computing, and lab rotations before declaring a major."
    ),
    "Genetics": (
        "Genomics and genetic-analysis training at College of Letters and Science connects to UW-Madison Gene Therapy and precision-medicine institutes."
    ),
    "Geography": (
        "Human and physical geography at College of Letters and Science uses GIS, remote sensing, and urban spatial-analysis projects in Madison."
    ),
    "Geological Engineering": (
        "Geological engineering in the College of Engineering integrates geotechnics, hydrogeology, and resource extraction for mining and environmental consulting."
    ),
    "Geoscience": (
        "Geoscience at the Department of Geoscience covers mineralogy, paleoclimate, and field camps across Wisconsin's glacial landscapes."
    ),
    "German": (
        "German language, literature, and culture at College of Letters and Science includes Berlin study-abroad and European intellectual-history coursework."
    ),
    "Gerontology": (
    ...
    "Industrial Engineering": (
        "Industrial and systems engineering at the College of Engineering covers operations research, health-systems engineering, and the Center for Quick Response Manufacturing."
    ),
    "Information Science": (
        "Information-science coursework covers data curation, human–computer interaction, and knowledge organization within College of Engineering CS."
    ),
    "Information Systems": (
        "Enterprise systems, databases, and IT governance training aligned with Wisconsin School of Business's analytics and health-information initiatives."
    ),
    "Insurance": (
        "UW-Madison actuarial and risk-management coursework spans property-casualty modeling, enterprise risk, and regulatory finance through Wisconsin School of Business and IEOR."
    ),
    "Interdisciplinary Studies": (
        "Custom interdisciplinary majors at College of Letters and Science let students combine two or more Madison campus departments around a faculty-advised thesis."
    ),
    ...
    "Materials Engineering": (
        "Materials science and engineering at the College of Engineering spans metallurgy, polymers, and nanomaterials in the Wisconsin Materials Research Center."
    ),
    "Mathematics": (
        "Pure and applied mathematics at College of Letters and Science spans analysis, algebra, and mathematical biology with small upper-level seminars."
    ),
    ...
    "Microbiology": (
        "Microbiology and immunology at College of Letters and Science studies pathogens, host defense, and vaccine science with BSL-3 lab access."
    ),
    ...
    "Nursing": (
        "School of Nursing programs combine UW-Madison Hospital clinical rotations with federally funded nursing research — ranked top-3 by U.S. News."
    ),
    "Nutrition Sciences": (
    ...
    "Polymer Engineering": (
        "Polymer engineering in the College of Engineering covers plastics processing, rheology, and the Wisconsin Institute for Discovery materials labs."
    ),
    "Psychology": (
        "Psychological and brain sciences at Madison campus is among the largest majors, with research tracks in clinical, cognitive, and social psychology."
    ),
    "Public Administration": (
        "Public administration at the La Follette School of Public Affairs trains policy analysts in budgeting, program evaluation, and Wisconsin state-government internships."
    ),
    "Public Health": (
        "Public-health coursework at SMPH covers epidemiology, health policy, and the Population Health Institute's Wisconsin health-equity initiatives."
    ),
    ...
    "Science and Technology Studies": (
        "Science and technology studies at Letters & Science examines science policy, bioethics, and the Holtz Center for Science and Technology Studies."
    ),
    "Secondary Education": (
    ...
    "Statistics": (
        "Statistics at Letters & Science spans biostatistics, data mining, and the Biometry Department's agricultural and medical trial collaborations."
    ),
    "Studio Art": (
        "History of Art studio practice at College of Letters and Science includes drawing, printmaking, and digital media with Madison gallery partnerships."
    ),
    "Sustainability Studies": (
        "Sustainability certificate programs at the Nelson Institute integrate ecology, policy, and the Office of Sustainability campus carbon-reduction initiatives."
    ),
    "Systems Engineering": (
        "Systems engineering in the College of Engineering covers model-based systems engineering, defense acquisition, and Wisconsin aerospace supplier networks."
    ),
    "TESOL": (
    ...
    "Veterinary Biomedical Sciences": (
        "Veterinary biomedical sciences research at UW-Madison covers infectious disease, comparative oncology, and translational animal health in the vet college."
    ),
    "Veterinary Medicine": (
...
SLUG_DESCRIPTIONS: dict[str, str] = {
    ...
    "uw-madison-business-administration-bs": (
        "The Wisconsin BBA emphasizes analytics, real estate, and entrepreneurship through the Weinert Center and Fortune 500 recruiting from Milwaukee and Chicago markets."
    ),
    "uw-madison-computer-science-bs": (
        "The Department of Computer Sciences at CDIS covers algorithms, systems, AI, and security — U.S. News ranks UW-Madison computer science among the nation's top public programs with ties to Epic Systems and American Family Insurance recruiting."
    ),
    "uw-madison-economics-bs": (
        "Economics at Letters & Science covers microeconomics, econometrics, and policy analysis with the Center for Demography of Health and Aging research network."
    ),
    "uw-madison-law-prof": (
        "The UW Law School J.D. emphasizes public-interest law, environmental regulation, and proximity to Wisconsin's state capitol and administrative agencies."
    ),
    "uw-madison-mba-ms": (
        "The Wisconsin full-time MBA at Grainger Hall emphasizes supply chain, brand management, and applied learning through the Erdman Center for Global Business."
    ),
    "uw-madison-mechanical-engineering-bs": (
        "Mechanical engineering at the College of Engineering spans thermofluids, design, robotics, and manufacturing with Engine Research Center and industry senior design."
    ),
    "uw-madison-medicine-prof": (
        "The SMPH M.D. program integrates Wisconsin Willed Body anatomy, rural health pathways, and UW Health clinical rotations across Madison and statewide sites."
    ),
    "uw-madison-nursing-bs": (
        "The School of Nursing BSN combines simulation labs, UW Health clinical rotations, and community health practica across Wisconsin hospital partners."
    ),
    "uw-madison-pharmacy-prof": (
        "The School of Pharmacy Pharm.D. emphasizes clinical practice, drug discovery, and the Zeeh Pharmaceutical Experiment Station on the Health Sciences campus."
    ),
    "uw-madison-psychology-bs": (
        "Psychology at Letters & Science spans cognitive, clinical, and social tracks with federally funded research labs and the Waisman Center partnership."
    ),
    "uw-madison-veterinary-medicine-prof": (
        "The School of Veterinary Medicine D.V.M. operates UW Veterinary Care teaching hospital with food-animal medicine across Wisconsin's dairy industry."
    ),
}
