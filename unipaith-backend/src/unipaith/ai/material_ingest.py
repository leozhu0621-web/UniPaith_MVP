...
_SYSTEM = (
    ...
    "For each job/internship, fill `description` with what the person did "
    "(their responsibilities in 1-2 sentences) AND `key_achievements` with the "
    "quantified result bullets — never leave `description` empty when the "
    "document describes the role. "
