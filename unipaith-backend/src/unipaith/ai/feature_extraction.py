...
STUDENT_FEATURE_PROMPT = """You are a feature extraction engine \
for a university admissions matching system.
...
PROGRAM_FEATURE_PROMPT = """You are a feature extraction engine \
for a university admissions matching system.
