"""Spec 48/49/50 — the build-transparency surface.

A read-only metadata layer that turns the three build-integration docs into
...
All three back the public ``/build/*`` endpoints and the ``/goal`` hub. They are
