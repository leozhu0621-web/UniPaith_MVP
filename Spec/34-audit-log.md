...
| `ai_generated` | AI artifact accepted / edited / rejected (per `35-ai-extensibility.md`). |
...
| `fairness_signal_override` | Per `43` §6 override. |
...
7 years per `43-data-rights-privacy.md` §5.
