# 12 · Discovery — Type-First Program Search
...
>
> Status: **draft v1.0** · 2026-05-29 · Route: `/s/explore` (search + filters region). Companion: `11-program-match.md`.
...
2. POST query → `DiscoveryQueryInterpreter` (`42-ai-agents-claude.md` §12).
...
Open via [Filters ▾]. Mirrors `40-prompt-library-schema.md` filter set + program-specific fields. Per Master Paper:
