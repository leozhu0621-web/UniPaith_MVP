...
Breakdown by program / intake + audience segment + time window. Feeds `26-attribution-funnel-analytics.md`.
...
- `CampaignAudienceCopySuggester` (`42` §16) — drafts post body + subject lines.
