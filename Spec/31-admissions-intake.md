...
- Authenticity risk flags (essay AI-pattern detection — per `45-ai-agents-claude.md` §18).
...
- Response template (per `25-campaigns.md` templates).
- Quick reply box.
- Assign to staff.
...
| `AuthenticityRiskScorer` (`45` §18) | On essay submit | Flag potential AI patterns |
...
- Daily intelligence digest currently AI but may be on GPT-4o; migrate to Claude per `04`.
