# 23 · Campaigns — Institution Outbound
...
Per `24-audience-segmentation.md`. Combine multiple segments + uploaded lists; deduplicate by email; apply suppression/opt-out lists.
...
|---|---|---|
| `CampaignAudienceCopySuggester` (`42` §16) | "Draft with AI" button | Subject + body draft |
...
- **Internal-vs-external send compliance.** Internal respects `consent.outreach`; external respects opt-out + uploaded-list source consent. Spec'd in `43-data-rights-privacy.md`.
