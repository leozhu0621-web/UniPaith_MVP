# 33 · Decisions & Offers (Institution-Side)

> Where institutions release decisions and offers, with terms (scholarship / conditions / response deadline). Mirrors the student-side `1A-decisions-offers.md`.
>
...
1. Reviewer/committee finalizes recommendation in `31-review-workspace.md`.
...
- Surface "no response after X days" yield-risk alert on dashboard (per `30` §2).
...
|---|---|---|
| `OutcomeBriefForOfferLetter` (`42` §15) | Generate offer | Plain-language brief that lands in student's offer view |
